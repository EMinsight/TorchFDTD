...
| 4 | P0 | 핵심 | Torch adjoint·자동미분 | 유전체·CPML·ADE·Bloch·PEC/PMC·tensor·밀도·polygon/spline 형상·소스 파형의 checkpointed adjoint와 N-port S·far-field 목적함수 구현(full autograd 대비 Taylor 검사). 남은 것: 고유모드·source 위치 미분, fused kernel의 PMC/tensor 경로, 동시 adjoint batch |
