...
| 6 | P1 | 필수 | 측정·분산 재료 | passive fitting·ADE forward 및 resident Torch·fused CUDA ADE backward 구현, 실험적 공간 ADE 연결, 분산 대규모 용량·속도 검증 후속 |
