...
| 5 | P0 | 핵심 | 계층형 메모리·대규모 실행 | 체크포인트 3계층, DRAM slab·비동기 전송·정책 선택 부분 구현. 물리적 VRAM 초과·통합 정책 검증은 남음 |
