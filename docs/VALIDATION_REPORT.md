...
Package version `0.14.0.dev0` (pyproject.toml). Gate file adopted at commit `f3efd3409aaa` with 83 tasks in 11 stages; newest evidence run `20260922T064526Z-g9-02-3d2ecc54` recorded 2026-09-22T06:45:26+00:00 at commit `1b46bc4d5172`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| WORKSTATION | G0, G1, G2, G3, G4, G5, G6, G7, G8, G9 | DRAFT_PENDING_RECONCILIATION_WITH_EXISTING_REQUIREMENTS | 29 | 48 | 0 | none | NOT RELEASABLE |
| HPC | G0, G1, G2, G3, G4, G5, G6, G7, G8, G9, H1 | DRAFT_PENDING_RECONCILIATION_WITH_EXISTING_REQUIREMENTS | 29 | 54 | 0 | none | NOT RELEASABLE |
...
| G9-02 | 코드와 번들 데이터의 출처·license·third-party notices·SBOM·dependency/security scan을 수행한다 | IMPLEMENTED | VERIFIED | `20260922T064526Z-g9-02-3d2ecc54` | `1b46bc4d5172` | PASS | evidence matches the current checkout |
...
| G9-07 | validation report를 기계 산출물에서 생성한다 | IMPLEMENTED | VERIFIED | `20260922T052219Z-g9-07-512b7fdc` | `5881dfaf3976` | FAIL | STALE: watched file changed since the run: scripts/build_validation_report.py |
