...
| --- | --- | --- | --- | --- | --- | --- | --- |
| WORKSTATION | G0, G1, G2, G3, G4, G5, G6, G7, G8, G9 | DRAFT_PENDING_RECONCILIATION_WITH_EXISTING_REQUIREMENTS | 50 | 27 | 0 | none | NOT RELEASABLE |
| HPC | G0, G1, G2, G3, G4, G5, G6, G7, G8, G9, H1 | DRAFT_PENDING_RECONCILIATION_WITH_EXISTING_REQUIREMENTS | 50 | 33 | 0 | none | NOT RELEASABLE |
...
| G9-07 | validation report를 기계 산출물에서 생성한다 | IMPLEMENTED | VERIFIED | `20260921T202555Z-g9-07-f8fe342e` | `1c191f4f2ae1` | PASS | evidence matches the current checkout |
