...
Package version `0.15.0` (pyproject.toml). Gate file adopted at commit `f3efd3409aaa` with 83 tasks in 11 stages; newest evidence run `20260923T085146Z-g9-01-a7b6ed12` recorded 2026-09-23T08:51:46+00:00 at commit `30494ee6fbde`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| G0-01 | 실제 HEAD/dirty tree/기존 계획/자원·권한 확인 | IMPLEMENTED | VERIFIED | `20260923T015312Z-g0-01-b108faa3` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G0-02 | RELEASE_SCOPE와 기능·검증 상태 분리 | IMPLEMENTED | VERIFIED | `20260923T015324Z-g0-02-29e3f1fd` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G0-03 | 기존 완료 계획·gate·fixture·raw evidence 단일 추적 | IMPLEMENTED | VERIFIED | `20260923T015331Z-g0-03-e83e4abe` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G0-04 | 필수 누락/실패/skip/source 불일치에서 출고 실패 판정기 | IMPLEMENTED | VERIFIED | `20260923T015546Z-g0-04-bfffa939` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G0-05 | 판정기 자체 failure injection과 세션 인계 구조 | IMPLEMENTED | VERIFIED | `20260923T015748Z-g0-05-513e4642` | `9ba879241b39` | PASS | evidence matches the current checkout |

### G1 과거 리뷰 회귀 및 수정 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G1-01 | 자동 graded mesh와 미분 평면 모델의 격자 불일치. | IMPLEMENTED | VERIFIED | `20260923T015817Z-g1-01-6cdecc7e` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G1-02 | reference signature의 실제 격자 누락. | IMPLEMENTED | VERIFIED | `20260923T015845Z-g1-02-9d3855c4` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G1-03 | quadrant_intensity_allocation의 FP32 불안정. | IMPLEMENTED | VERIFIED | `20260923T015906Z-g1-03-7b04fa07` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G1-04 | restart 코드 호환성 검사 누락. | IMPLEMENTED | VERIFIED | `20260923T020323Z-g1-04-6fcc44c4` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G1-05 | journal 저장공간 산정. | IMPLEMENTED | VERIFIED | `20260923T020737Z-g1-05-01697526` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G1-06 | 문서/실행 경로 일치. | IMPLEMENTED | VERIFIED | `20260923T020747Z-g1-06-78a77a52` | `9ba879241b39` | PASS | evidence matches the current checkout |

### G2 물리·격자·실행 계약 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G2-01 | 기존 구조를 활용하여 immutable resolved/compiled simulation plan을 만든다 | IMPLEMENTED | VERIFIED | `20260923T020759Z-g2-01-343bace3` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G2-02 | forward/adjoint/streamed/tensor batch/GUI가 서로 다른 규칙으로 물리 입력을 다시 해석하지 않도록 한다 | IMPLEMENTED | VERIFIED | `20260923T020808Z-g2-02-e9628a2b` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G2-03 | capability registry를 만들고 dimensions × mesh × materials × boundaries × sources × monitors × forward/backward × resident/streamed × precision/backend의 유효 조합을 명시한다 | IMPLEMENTED | VERIFIED | `20260923T020855Z-g2-03-311a4450` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G2-04 | 전수 조합 대신 위험 기반 pairwise 검사와 고위험 3~4개 기능 조합을 설계한다 | IMPLEMENTED | VERIFIED | `20260923T020939Z-g2-04-452fe590` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G2-05 | "+/- DFT", Bloch spatial phase, E/H half-step, normal/outward direction, reduced units vs SI calibration, lossy exterior, 2D 단위길이 전력을 공개 specification과 테스트로 고정한다. | IMPLEMENTED | VERIFIED | `20260923T020954Z-g2-05-1e628e43` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G2-06 | cache/reference/restart마다 필요한 동일성 조건을 분리한다 | IMPLEMENTED | VERIFIED | `20260923T021009Z-g2-06-129bf256` | `9ba879241b39` | PASS | evidence matches the current checkout |

### G3 독립 물리·gradient 검증 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G3-01 | 균일 매질 2D/3D 전파·위상·분산 | IMPLEMENTED | VERIFIED | `20260923T021325Z-g3-01-9fcd1221` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G3-02 | 유전체 slab normal/oblique TE/TM과 TMM | IMPLEMENTED | VERIFIED | `20260923T021749Z-g3-02-de257a36` | `9ba879241b39` | PASS | scope change pending approval (2 declaration(s), scope_change_approval is null): docs/validation/cases/G3-02_dielectric_slab_tmm.oracles.json declares superseded_by (a revised case); and 1 more |
| G3-03 | Drude/Lorentz slab fit/ADE 오차 분리 | IMPLEMENTED | VERIFIED | `20260923T021859Z-g3-03-be04bedf` | `9ba879241b39` | PASS | evidence matches the current checkout |
| G3-04 | dielectric cylinder/sphere Mie 산란 | IMPLEMENTED | VERIFIED | `20260923T023409Z-g3-04-f7ba808f` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (1 paths); it is not tied to commit 9ba879241b39 alone |
| G3-05 | 금속/분산 곡면 산란·흡수 수렴 | IMPLEMENTED | FAILED | `20260923T033229Z-g3-05-c3f1ab53` | `9ba879241b39` | FAIL | verification_state is FAILED |
| G3-06 | PEC/PMC cavity·symmetry와 gradient mapping | IMPLEMENTED | VERIFIED | `20260923T033401Z-g3-06-03365bc5` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (2 paths); it is not tied to commit 9ba879241b39 alone |
| G3-07 | PML normal/oblique 반사·장시간 안정성 | IMPLEMENTED | VERIFIED | `20260923T033514Z-g3-07-0c405a29` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (2 paths); it is not tied to commit 9ba879241b39 alone |
| G3-08 | Bloch grating·회절과 독립 RCWA | IMPLEMENTED | VERIFIED | `20260923T040705Z-g3-08-4c62d94c` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
| G3-09 | mode neff·field·confinement·power oracle | IMPLEMENTED | VERIFIED | `20260923T040723Z-g3-09-ad9ce200` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
| G3-10 | PIC S·수동성·상반성과 누락 방사 채널 | IMPLEMENTED | VERIFIED | `20260923T041117Z-g3-10-c017582d` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
| G3-11 | dipole far/near field와 표면/격자 수렴 | IMPLEMENTED | VERIFIED | `20260923T041150Z-g3-11-a0a719bd` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
| G3-12 | tensor slab 및 tensor gradient | IMPLEMENTED | VERIFIED | `20260923T041443Z-g3-12-3e345f17` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
| G3-13 | 곡면 grid offset/mesh/smoothing 폭 물리 수렴 | IMPLEMENTED | VERIFIED | `20260923T041829Z-g3-13-c1d509fa` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G3-14 | 무차원 small discrete CPU/Torch/CUDA/VJP 수치 비교 | IMPLEMENTED | VERIFIED | `20260923T041941Z-g3-14-8d297356` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G3-15 | full-autograd·directional VJP·FD sweep·Taylor 검사 | IMPLEMENTED | VERIFIED | `20260923T042029Z-g3-15-df51ddec` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G3-16 | 실제 shape/material 파라미터의 물리 gradient 수렴 | IMPLEMENTED | VERIFIED | `20260923T042123Z-g3-16-6f5198d9` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G3-17 | oracle 독립성·정밀도·시간·PML 오차 budget 확인 | IMPLEMENTED | VERIFIED | `20260923T042135Z-g3-17-3c8ac8b1` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |

### G4 CUDA·CI·환경 검증 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G4-01 | 보유한 실제 GPU와 OS·driver·runtime부터 확인한다 | IMPLEMENTED | VERIFIED | `20260923T042153Z-g4-01-f0212da8` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-02 | torch/fused, CUDA graph on/off, fused/reference monitor, FP32/FP64, real/complex, standard/nondefault stream의 valid 경로를 비교한다. | IMPLEMENTED | VERIFIED | `20260923T042229Z-g4-02-5acbf56f` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-03 | noncontiguous tensors, duplicate observers, multiple calls/backward, input lifetime, stream synchronization, cancellation, allocator cleanup을 검사한다 | IMPLEMENTED | VERIFIED | `20260923T042254Z-g4-03-3e636cc3` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-04 | 최소 격자·홀수 크기·부분 slab·비정렬 tile·index boundary·강한 material contrast·ADE/CPML memory를 무작위/경계 fixture에 포함한다 | IMPLEMENTED | VERIFIED | `20260923T042326Z-g4-04-5d1fc9c6` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-05 | CPU PR suite, 신뢰한 코드의 GPU 정기 suite, 실제 release의 전체 GPU suite를 분리한다 | IMPLEMENTED | VERIFIED | `20260923T042658Z-g4-05-f04e7ecb` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-06 | public fork PR의 untrusted code를 개인/연구실 GPU host에서 자동 실행하지 않는다 | IMPLEMENTED | VERIFIED | `20260923T042713Z-g4-06-61d814f9` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |

### G5 메모리·재시작·장기 안정성 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G5-01 | resident/host/disk/async 경로를 같은 물리 문제·관측자·목적함수에서 비교한다 | IMPLEMENTED | VERIFIED | `20260923T042926Z-g5-01-62b6dd06` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-02 | peak Torch allocated/reserved, CUDA 전체 process memory(가용한 계측 사용), RSS/PSS 또는 플랫폼 동등량, committed memory, OS cache, 디스크 사용량·총 읽기/쓰기·실효 대역폭을 구분한다 | IMPLEMENTED | VERIFIED | `20260923T042947Z-g5-02-cbb37667` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-03 | planner의 byte admission과 실제 peak를 맞추고 원자적 동시 reservation 또는 동등 admission으로 여러 작업이 각각 free memory를 보고 동시에 초과하는 문제를 다룬다 | IMPLEMENTED | VERIFIED | `20260923T043008Z-g5-03-625fdc11` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-04 | 전체 3D epsilon/VJP를 만들지 않는 geometry/density slab 생성·gradient 축약 경로를 공개 합성 구조로 시험한다 | IMPLEMENTED | VERIFIED | `20260923T043056Z-g5-04-02724d67` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-05 | meaningful beyond-VRAM 사례 하나를 추가한다 | IMPLEMENTED | VERIFIED | `20260923T043111Z-g5-05-e3c7efa3` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-06 | 위 대규모 사례는 승인된 실행/디스크 쓰기 예산 안에서 수행한다 | IMPLEMENTED | VERIFIED | `20260923T043127Z-g5-06-5f8f80d2` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-07 | forward 중단, backward 중단, process kill, simulated ENOSPC/OOM, read/write fault, truncate/checksum 오류, CUDA transfer failure, cancellation을 주입한다 | IMPLEMENTED | VERIFIED | `20260923T043624Z-g5-07-32449d89` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-08 | checkpoint에 solver와 필요한 auxiliary states, optimizer state, scheduler/projection state, RNG, effective source, configuration fingerprint를 보존한다 | IMPLEMENTED | VERIFIED | `20260923T043828Z-g5-08-ac371944` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-09 | journal은 run별 소유권과 동시 writer 잠금을 갖는다 | IMPLEMENTED | VERIFIED | `20260923T044105Z-g5-09-5f476b73` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-10 | 경량 fixture에서 1e5 steps, 반복 실행, 최소 100 optimizer updates 및 승인된 장시간 soak를 수행한다 | IMPLEMENTED | VERIFIED | `20260923T044114Z-g5-10-f85f72fe` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |

### G6 사용자 물리·역설계 API (WORKSTATION, P1)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G6-01 | 재료 CSV/nk/epsilon import, passive fitting, 원자료 출처·사용권·해시, fit band, 시간 이산화에 따른 n/k 오차, extrapolation 경고를 하나의 workflow로 묶는다 | IMPLEMENTED | VERIFIED | `20260923T044129Z-g6-01-b59302cf` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-02 | source의 실제 공간 분포·위상·편광·시간 파형·유효 bandwidth를 preview한다 | IMPLEMENTED | VERIFIED | `20260923T044144Z-g6-02-d106078d` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-03 | reference를 포함한 R/T/A, 복소 S, phase/group delay, mode decomposition, diffraction, far-field/near-zone을 기존 결과와 통합한다 | IMPLEMENTED | VERIFIED | `20260923T044224Z-g6-03-054a0040` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-04 | 포트별 mode tracking, normalization, reference plane, forward/backward separation과 퇴화/약한 모드 진단을 제공한다 | IMPLEMENTED | VERIFIED | `20260923T044234Z-g6-04-2f397d8e` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-05 | 기존 design/periodic/mode-network API를 재사용해 objective→parameterization→optimizer→history→resume→final evaluation의 최소 고수준 인터페이스를 통합한다 | IMPLEMENTED | VERIFIED | `20260923T052003Z-g6-05-a93e7a97` | `f0a04477f5de` | PASS | evidence matches the current checkout |
| G6-06 | density filter, projection, beta continuation, symmetry, mask, min linewidth/gap, fabrication perturbation, binary export를 실제 검사와 연결한다 | IMPLEMENTED | VERIFIED | `20260923T052141Z-g6-06-5bb897b9` | `f0a04477f5de` | PASS | evidence matches the current checkout |
| G6-07 | export된 binary/GDS 구조를 다시 import하여 독립 finer forward로 평가한다 | IMPLEMENTED | VERIFIED | `20260923T050737Z-g6-07-a39e1eb7` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G6-08 | low-intensity/near-zero reference/frequency cutoff/evanescent/backflow에서 NaN·음의 국소 flux·invalid phase를 임의 clipping으로 숨기지 않는다 | IMPLEMENTED | VERIFIED | `20260923T050756Z-g6-08-df947a4f` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
...
| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G8-01 | 기존 Project JSON/NPZ compatibility와 schema migration을 시험한다 | IMPLEMENTED | VERIFIED | `20260923T050811Z-g8-01-47f042fc` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-02 | 큰 결과의 chunked/lazy read가 필요하면 HDF5 또는 Zarr 중 요구에 맞는 한 구현을 우선 채택한다 | IMPLEMENTED | VERIFIED | `20260923T050824Z-g8-02-aefb6942` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-03 | GUI의 CAD/GDS → material/source/boundary → 실제 mesh preview → resource preflight → job queue → cancel/resume → 결과 overlay → 데이터/GDS export 경로를 E2E로 시험한다. | IMPLEMENTED | VERIFIED | `20260923T050835Z-g8-03-9114813f` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-04 | geometry 편집의 undo/redo, copy/multiselect, autosave/recovery, versioned project, 구조/parameter 단위 검증과 결과 stale 표시를 구현/확인한다 | IMPLEMENTED | VERIFIED | `20260923T050850Z-g8-04-9cab3e41` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-05 | 최종 wheel에 frontend 정적 자산을 포함하고 최종 사용자가 Node/npm이나 저장소 checkout 없이 UI를 실행하도록 한다 | IMPLEMENTED | VERIFIED | `20260923T050909Z-g8-05-d20650f4` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-06 | 지원 Python/Torch/CuPy/runtime 최소·최대 버전을 실제 설치 시험으로 확정한다 | IMPLEMENTED | VERIFIED | `20260923T050924Z-g8-06-87040c4d` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-07 | README의 모든 기본 예제를 installed wheel에서 실행한다 | IMPLEMENTED | VERIFIED | `20260923T050935Z-g8-07-6be44a90` | `9ba879241b39` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |

### G9 보안·운영·출고 판정 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G9-01 | local server의 loopback 기본값, origin/host 검증, 허용된 파일 경로, 업로드 크기, path traversal, 악성/손상 JSON/NPZ/GDS, 압축 폭탄과 unsafe pickle을 검사한다 | IMPLEMENTED | VERIFIED | `20260923T085146Z-g9-01-a7b6ed12` | `30494ee6fbde` | PASS | evidence matches the current checkout |
...
| G9-04 | API stability/deprecation, project/result/checkpoint version compatibility, changelog, 알려진 한계, bug template, minimal repro, numerical bug severity, release rollback/결과 영향 공지를 준비한다. | IMPLEMENTED | VERIFIED | `20260923T080205Z-g9-04-03b0495b` | `b9f0341a4d46` | PASS | evidence matches the current checkout |
...
| G9-06 | 최종 release candidate의 정확한 source tree와 wheel에서 전체 필수 gate를 실행한다 | IN_PROGRESS | VERIFIED | `20260923T074741Z-g9-06-47bc6631` | `b2f060510b0c` | FAIL | STALE: test source changed since the run: tests/test_server_security.py |
...
Newest record `20260923T014045Z-00a8d296.json` (kind `clean_install_record`), taken at commit `00a8d296bfa8` on 2026-09-23T01:40:45+00:00 with 0 dirty packaging paths; all steps passed: yes.

Wheel `torchfdtd-0.15.0-py3-none-any.whl`, SHA-256 `9382af263e93077a7cd49189798e54a8b669fd8b6a189e6cf759094147804824`, 968,615 bytes, 159 entries, 152 package files; browser assets match the committed ones: yes; frontend assets current: yes.
...
| Step | Status | Seconds |
| --- | --- | --- |
| build_wheel | passed | 15.29 |
| cpu_venv_create | passed | 15.52 |
| cpu_pip_install_torch | passed | 93.45 |
| cpu_pip_install_wheel | passed | 54.43 |
| cpu_package_list | passed | 0.89 |
| cpu_import_run_save_load | passed | 10.33 |
| cpu_server_index_assets_api | passed | 4.1 |
| cpu_doctor | passed | 3.45 |
| cuda_venv_create | passed | 16.57 |
| cuda_pip_install_torch | passed | 189.72 |
| cuda_pip_install_wheel_extras | passed | 64.69 |
| cuda_package_list | passed | 1.39 |
| cuda_fused_forward_run | passed | 17.6 |
| cuda_doctor | passed | 3.96 |
| readme_examples | passed | 14.48 |
...
| G3-06 | PEC/PMC cavity eigenfrequency, symmetry-reduced versus full domain, and gradient mapping | none (the test assertions are the record) | the pass/fail assertions of the required tests | 93 passed, 0 failed, 0 skipped in `20260923T033401Z-g3-06-03365bc5` | VERIFIED |
...
| G3-09 | Mode solver effective index, field, confinement and power against analytic slab and fiber oracles | none (the test assertions are the record) | the pass/fail assertions of the required tests | 32 passed, 0 failed, 0 skipped in `20260923T040723Z-g3-09-ad9ce200` | VERIFIED |
| G3-10 | PIC mode-port networks: straight guide, discontinuity, Y branch and crossing S, reciprocity, passivity with the radiation defect measured | none (the test assertions are the record) | the pass/fail assertions of the required tests | 23 passed, 0 failed, 0 skipped in `20260923T041117Z-g3-10-c017582d` | VERIFIED |
| G3-11 | Dipole radiation: near-to-far and near-zone projection against analytic Hertzian fields, native far-field pattern convergence | none (the test assertions are the record) | the pass/fail assertions of the required tests | 56 passed, 0 failed, 0 skipped in `20260923T041150Z-g3-11-a0a719bd` | VERIFIED |
| G3-12 | Tensor dielectrics: eigenpolarization dispersion, birefringent slab transmission and tensor gradients | none (the test assertions are the record) | the pass/fail assertions of the required tests | 45 passed, 0 failed, 0 skipped in `20260923T041443Z-g3-12-3e345f17` | VERIFIED |
...
| G3-14 | Small discrete problems: CPU torch, CUDA torch, fused CUDA, streamed and reversible forward and VJP agreement | none (the test assertions are the record) | the pass/fail assertions of the required tests | 75 passed, 0 failed, 0 skipped in `20260923T041941Z-g3-14-8d297356` | VERIFIED |
| G3-15 | Full-autograd oracle, explicit adjoint, central-difference step sweep, Taylor remainder and directional VJP checks | none (the test assertions are the record) | the pass/fail assertions of the required tests | 34 passed, 0 failed, 0 skipped in `20260923T042029Z-g3-15-df51ddec` | VERIFIED |
| G3-16 | Physical shape and material parameter gradients: slab thickness and permittivity against the Airy derivative, polygon vertices under mesh refinement | none (the test assertions are the record) | the pass/fail assertions of the required tests | 19 passed, 0 failed, 0 skipped in `20260923T042123Z-g3-16-6f5198d9` | VERIFIED |
| G3-17 | Oracle independence, precision floor, time-window and PML error budgets of every G3 fixture | none (the test assertions are the record) | the pass/fail assertions of the required tests | 4 passed, 0 failed, 0 skipped in `20260923T042135Z-g3-17-3c8ac8b1` | VERIFIED |
...
| G3-04 | evidence was recorded on a dirty tree (1 paths); it is not tied to commit 9ba879241b39 alone |
| G3-06 | evidence was recorded on a dirty tree (2 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-07 | evidence was recorded on a dirty tree (2 paths); it is not tied to commit 9ba879241b39 alone |
| G3-08 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-09 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-10 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-11 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-12 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-13 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G3-14 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-15 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-16 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
...
| G3-17 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-01 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-02 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-03 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-04 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-05 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G4-06 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-01 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-02 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-03 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-04 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-05 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-06 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-07 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-08 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-09 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G5-10 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-01 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-02 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-03 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
| G6-04 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit 9ba879241b39 alone |
...
| G6-07 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G6-08 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-01 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-02 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-03 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-04 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-05 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-06 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G8-07 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
| G9-02 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit 9ba879241b39 alone |
