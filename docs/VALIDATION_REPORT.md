...
Package version `0.15.0` (pyproject.toml). Gate file adopted at commit `f3efd3409aaa` with 83 tasks in 11 stages; newest evidence run `20260923T235752Z-g9-06-b92d9083` recorded 2026-09-23T23:57:52+00:00 at commit `3338a4b9a3a9`.
...
| G1-06 | 문서/실행 경로 일치. | IMPLEMENTED | VERIFIED | `20260923T181907Z-g1-06-501f1f0e` | `4635db7eab69` | PASS | evidence matches the current checkout |
...
| G3-02 | 유전체 slab normal/oblique TE/TM과 TMM | IMPLEMENTED | VERIFIED | `20260923T183251Z-g3-02-e90cd4d2` | `4635db7eab69` | PASS | scope change pending approval (2 declaration(s), scope_change_approval is null): docs/validation/cases/G3-02_dielectric_slab_tmm.oracles.json declares superseded_by (a revised case); and 1 more |
...
| G3-09 | mode neff·field·confinement·power oracle | IMPLEMENTED | VERIFIED | `20260923T212310Z-g3-09-e55a1b01` | `3e9300300d15` | PASS | scope change pending approval (4 declaration(s), scope_change_approval is null): docs/validation/cases/G3-09_mode_solver_oracles.json acceptance/fiber_beta_relative_error_max/difference_from_common_criterion states a limit looser than the program threshold; and 3 more |
| G3-10 | PIC S·수동성·상반성과 누락 방사 채널 | IMPLEMENTED | VERIFIED | `20260923T212720Z-g3-10-f3da775f` | `3e9300300d15` | PASS | scope change pending approval (2 declaration(s), scope_change_approval is null): docs/validation/cases/G3-10_pic_networks.json acceptance/material_vjp/y_branch/rtol = 0.001 is looser than the loosest program rtol 0.0001; and 1 more |
| G3-11 | dipole far/near field와 표면/격자 수렴 | IMPLEMENTED | VERIFIED | `20260923T212746Z-g3-11-1121cd71` | `3e9300300d15` | PASS | scope change pending approval (1 declaration(s), scope_change_approval is null): docs/validation/cases/G3-11_dipole_radiation.json acceptance/near_flux_versus_far_power/rtol = 0.0005 is looser than the loosest program rtol 0.0001 |
| G3-12 | tensor slab 및 tensor gradient | IMPLEMENTED | VERIFIED | `20260923T213042Z-g3-12-9d50987d` | `3e9300300d15` | PASS | scope change pending approval (3 declaration(s), scope_change_approval is null): docs/validation/cases/G3-12_tensor_slab.json acceptance/slab/difference_from_common_criterion states a limit looser than the program threshold; and 2 more |
...
| G6-04 | 포트별 mode tracking, normalization, reference plane, forward/backward separation과 퇴화/약한 모드 진단을 제공한다 | IMPLEMENTED | VERIFIED | `20260923T222457Z-g6-04-3241b7e8` | `9d2eb55a1955` | PASS | scope change pending approval (2 declaration(s), scope_change_approval is null): docs/validation/cases/G6-04.json acceptance/tracked_neff_error_max/difference_from_common_criterion states a limit looser than the program threshold; and 1 more |
...
| G8-05 | 최종 wheel에 frontend 정적 자산을 포함하고 최종 사용자가 Node/npm이나 저장소 checkout 없이 UI를 실행하도록 한다 | IMPLEMENTED | VERIFIED | `20260923T224933Z-g8-05-e43c34bc` | `9d2eb55a1955` | PASS | evidence was recorded on a dirty tree (6 paths); it is not tied to commit 9d2eb55a1955 alone |
| G8-06 | 지원 Python/Torch/CuPy/runtime 최소·최대 버전을 실제 설치 시험으로 확정한다 | IMPLEMENTED | VERIFIED | `20260923T224943Z-g8-06-7de9aa28` | `9d2eb55a1955` | PASS | evidence was recorded on a dirty tree (6 paths); it is not tied to commit 9d2eb55a1955 alone |
| G8-07 | README의 모든 기본 예제를 installed wheel에서 실행한다 | IMPLEMENTED | VERIFIED | `20260923T224951Z-g8-07-b1345db8` | `9d2eb55a1955` | PASS | evidence was recorded on a dirty tree (6 paths); it is not tied to commit 9d2eb55a1955 alone |
...
| G8-05 | evidence was recorded on a dirty tree (6 paths); it is not tied to commit 9d2eb55a1955 alone |
| G8-06 | evidence was recorded on a dirty tree (6 paths); it is not tied to commit 9d2eb55a1955 alone |
| G8-07 | evidence was recorded on a dirty tree (6 paths); it is not tied to commit 9d2eb55a1955 alone |
