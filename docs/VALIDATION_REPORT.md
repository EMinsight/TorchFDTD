...
Package version `0.15.0` (pyproject.toml). Gate file adopted at commit `f3efd3409aaa` with 83 tasks in 11 stages; newest evidence run `20260923T162502Z-g9-06-c90ef9ab` recorded 2026-09-23T16:25:02+00:00 at commit `47bd8ace3e69`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| G0-01 | 실제 HEAD/dirty tree/기존 계획/자원·권한 확인 | IMPLEMENTED | VERIFIED | `20260923T114705Z-g0-01-6b89b72b` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G0-02 | RELEASE_SCOPE와 기능·검증 상태 분리 | IMPLEMENTED | VERIFIED | `20260923T114722Z-g0-02-2dbc5325` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G0-03 | 기존 완료 계획·gate·fixture·raw evidence 단일 추적 | IMPLEMENTED | VERIFIED | `20260923T114734Z-g0-03-b899ef06` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G0-04 | 필수 누락/실패/skip/source 불일치에서 출고 실패 판정기 | IMPLEMENTED | VERIFIED | `20260923T115024Z-g0-04-03145ee1` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G0-05 | 판정기 자체 failure injection과 세션 인계 구조 | IMPLEMENTED | VERIFIED | `20260923T115417Z-g0-05-7f98f66d` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |

### G1 과거 리뷰 회귀 및 수정 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G1-01 | 자동 graded mesh와 미분 평면 모델의 격자 불일치. | IMPLEMENTED | VERIFIED | `20260923T115455Z-g1-01-dc61e590` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G1-02 | reference signature의 실제 격자 누락. | IMPLEMENTED | VERIFIED | `20260923T115524Z-g1-02-db3390fa` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G1-03 | quadrant_intensity_allocation의 FP32 불안정. | IMPLEMENTED | VERIFIED | `20260923T115551Z-g1-03-5b818885` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G1-04 | restart 코드 호환성 검사 누락. | IMPLEMENTED | VERIFIED | `20260923T120014Z-g1-04-7f1e02b6` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G1-05 | journal 저장공간 산정. | IMPLEMENTED | VERIFIED | `20260923T120439Z-g1-05-3590f8ee` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G1-06 | 문서/실행 경로 일치. | IMPLEMENTED | VERIFIED | `20260923T120503Z-g1-06-bd388ef0` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |

### G2 물리·격자·실행 계약 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G2-01 | 기존 구조를 활용하여 immutable resolved/compiled simulation plan을 만든다 | IMPLEMENTED | VERIFIED | `20260923T120516Z-g2-01-da49bfe6` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G2-02 | forward/adjoint/streamed/tensor batch/GUI가 서로 다른 규칙으로 물리 입력을 다시 해석하지 않도록 한다 | IMPLEMENTED | VERIFIED | `20260923T120535Z-g2-02-18f261f8` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G2-03 | capability registry를 만들고 dimensions × mesh × materials × boundaries × sources × monitors × forward/backward × resident/streamed × precision/backend의 유효 조합을 명시한다 | IMPLEMENTED | VERIFIED | `20260923T120627Z-g2-03-54c6224d` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G2-04 | 전수 조합 대신 위험 기반 pairwise 검사와 고위험 3~4개 기능 조합을 설계한다 | IMPLEMENTED | VERIFIED | `20260923T120714Z-g2-04-77c92ee0` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G2-05 | "+/- DFT", Bloch spatial phase, E/H half-step, normal/outward direction, reduced units vs SI calibration, lossy exterior, 2D 단위길이 전력을 공개 specification과 테스트로 고정한다. | IMPLEMENTED | VERIFIED | `20260923T120732Z-g2-05-ed21c58c` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G2-06 | cache/reference/restart마다 필요한 동일성 조건을 분리한다 | IMPLEMENTED | VERIFIED | `20260923T120748Z-g2-06-d6690446` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |

### G3 독립 물리·gradient 검증 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G3-01 | 균일 매질 2D/3D 전파·위상·분산 | IMPLEMENTED | VERIFIED | `20260923T121112Z-g3-01-19465f27` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G3-02 | 유전체 slab normal/oblique TE/TM과 TMM | IMPLEMENTED | VERIFIED | `20260923T121544Z-g3-02-d3d5f429` | `aa3f8c1506b5` | PASS | scope change pending approval (2 declaration(s), scope_change_approval is null): docs/validation/cases/G3-02_dielectric_slab_tmm.oracles.json declares superseded_by (a revised case); and 1 more |
| G3-03 | Drude/Lorentz slab fit/ADE 오차 분리 | IMPLEMENTED | VERIFIED | `20260923T121658Z-g3-03-cccdf4d1` | `aa3f8c1506b5` | PASS | evidence matches the current checkout |
| G3-04 | dielectric cylinder/sphere Mie 산란 | IMPLEMENTED | VERIFIED | `20260923T123204Z-g3-04-05d2c627` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (1 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-05 | 금속/분산 곡면 산란·흡수 수렴 | IMPLEMENTED | FAILED | `20260923T132959Z-g3-05-819bbad4` | `aa3f8c1506b5` | FAIL | verification_state is FAILED |
| G3-06 | PEC/PMC cavity·symmetry와 gradient mapping | IMPLEMENTED | VERIFIED | `20260923T133125Z-g3-06-8f106f4b` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (2 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-07 | PML normal/oblique 반사·장시간 안정성 | IMPLEMENTED | VERIFIED | `20260923T133246Z-g3-07-cbe45435` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (2 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-08 | Bloch grating·회절과 독립 RCWA | IMPLEMENTED | VERIFIED | `20260923T140629Z-g3-08-37e9bcf3` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-09 | mode neff·field·confinement·power oracle | IMPLEMENTED | VERIFIED | `20260923T140645Z-g3-09-1415252b` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-10 | PIC S·수동성·상반성과 누락 방사 채널 | IMPLEMENTED | VERIFIED | `20260923T141102Z-g3-10-3d8a3f19` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-11 | dipole far/near field와 표면/격자 수렴 | IMPLEMENTED | VERIFIED | `20260923T141130Z-g3-11-0f66eb2a` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-12 | tensor slab 및 tensor gradient | IMPLEMENTED | VERIFIED | `20260923T141435Z-g3-12-d81a898c` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-13 | 곡면 grid offset/mesh/smoothing 폭 물리 수렴 | IMPLEMENTED | VERIFIED | `20260923T141810Z-g3-13-8880e833` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-14 | 무차원 small discrete CPU/Torch/CUDA/VJP 수치 비교 | IMPLEMENTED | VERIFIED | `20260923T141920Z-g3-14-daa944f0` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-15 | full-autograd·directional VJP·FD sweep·Taylor 검사 | IMPLEMENTED | VERIFIED | `20260923T142013Z-g3-15-20b354d0` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-16 | 실제 shape/material 파라미터의 물리 gradient 수렴 | IMPLEMENTED | VERIFIED | `20260923T142107Z-g3-16-afd7ad6e` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-17 | oracle 독립성·정밀도·시간·PML 오차 budget 확인 | IMPLEMENTED | VERIFIED | `20260923T142121Z-g3-17-ce8e7971` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |

### G4 CUDA·CI·환경 검증 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G4-01 | 보유한 실제 GPU와 OS·driver·runtime부터 확인한다 | IMPLEMENTED | VERIFIED | `20260923T142145Z-g4-01-425ce442` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-02 | torch/fused, CUDA graph on/off, fused/reference monitor, FP32/FP64, real/complex, standard/nondefault stream의 valid 경로를 비교한다. | IMPLEMENTED | VERIFIED | `20260923T142227Z-g4-02-69c5dfbc` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-03 | noncontiguous tensors, duplicate observers, multiple calls/backward, input lifetime, stream synchronization, cancellation, allocator cleanup을 검사한다 | IMPLEMENTED | VERIFIED | `20260923T142248Z-g4-03-3fc0fde3` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-04 | 최소 격자·홀수 크기·부분 slab·비정렬 tile·index boundary·강한 material contrast·ADE/CPML memory를 무작위/경계 fixture에 포함한다 | IMPLEMENTED | VERIFIED | `20260923T142320Z-g4-04-c438e262` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-05 | CPU PR suite, 신뢰한 코드의 GPU 정기 suite, 실제 release의 전체 GPU suite를 분리한다 | IMPLEMENTED | VERIFIED | `20260923T142650Z-g4-05-e0edcc9e` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-06 | public fork PR의 untrusted code를 개인/연구실 GPU host에서 자동 실행하지 않는다 | IMPLEMENTED | VERIFIED | `20260923T142707Z-g4-06-c173d093` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |

### G5 메모리·재시작·장기 안정성 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G5-01 | resident/host/disk/async 경로를 같은 물리 문제·관측자·목적함수에서 비교한다 | IMPLEMENTED | VERIFIED | `20260923T142913Z-g5-01-de221da2` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-02 | peak Torch allocated/reserved, CUDA 전체 process memory(가용한 계측 사용), RSS/PSS 또는 플랫폼 동등량, committed memory, OS cache, 디스크 사용량·총 읽기/쓰기·실효 대역폭을 구분한다 | IMPLEMENTED | VERIFIED | `20260923T142937Z-g5-02-2f54180c` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-03 | planner의 byte admission과 실제 peak를 맞추고 원자적 동시 reservation 또는 동등 admission으로 여러 작업이 각각 free memory를 보고 동시에 초과하는 문제를 다룬다 | IMPLEMENTED | VERIFIED | `20260923T143001Z-g5-03-546d2aec` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-04 | 전체 3D epsilon/VJP를 만들지 않는 geometry/density slab 생성·gradient 축약 경로를 공개 합성 구조로 시험한다 | IMPLEMENTED | VERIFIED | `20260923T143047Z-g5-04-1f022e98` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-05 | meaningful beyond-VRAM 사례 하나를 추가한다 | IMPLEMENTED | VERIFIED | `20260923T143058Z-g5-05-ae197e34` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-06 | 위 대규모 사례는 승인된 실행/디스크 쓰기 예산 안에서 수행한다 | IMPLEMENTED | VERIFIED | `20260923T143105Z-g5-06-b6eb1f3c` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-07 | forward 중단, backward 중단, process kill, simulated ENOSPC/OOM, read/write fault, truncate/checksum 오류, CUDA transfer failure, cancellation을 주입한다 | IMPLEMENTED | VERIFIED | `20260923T143554Z-g5-07-918d02ed` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-08 | checkpoint에 solver와 필요한 auxiliary states, optimizer state, scheduler/projection state, RNG, effective source, configuration fingerprint를 보존한다 | IMPLEMENTED | VERIFIED | `20260923T143802Z-g5-08-e2e5cd35` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-09 | journal은 run별 소유권과 동시 writer 잠금을 갖는다 | IMPLEMENTED | VERIFIED | `20260923T144036Z-g5-09-8468e676` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-10 | 경량 fixture에서 1e5 steps, 반복 실행, 최소 100 optimizer updates 및 승인된 장시간 soak를 수행한다 | IMPLEMENTED | VERIFIED | `20260923T144050Z-g5-10-a56357bd` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |

### G6 사용자 물리·역설계 API (WORKSTATION, P1)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G6-01 | 재료 CSV/nk/epsilon import, passive fitting, 원자료 출처·사용권·해시, fit band, 시간 이산화에 따른 n/k 오차, extrapolation 경고를 하나의 workflow로 묶는다 | IMPLEMENTED | VERIFIED | `20260923T144110Z-g6-01-899faccb` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-02 | source의 실제 공간 분포·위상·편광·시간 파형·유효 bandwidth를 preview한다 | IMPLEMENTED | VERIFIED | `20260923T144130Z-g6-02-df8a6e4f` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-03 | reference를 포함한 R/T/A, 복소 S, phase/group delay, mode decomposition, diffraction, far-field/near-zone을 기존 결과와 통합한다 | IMPLEMENTED | VERIFIED | `20260923T144216Z-g6-03-4ba8cff8` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-04 | 포트별 mode tracking, normalization, reference plane, forward/backward separation과 퇴화/약한 모드 진단을 제공한다 | IMPLEMENTED | VERIFIED | `20260923T144228Z-g6-04-f20bd916` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-05 | 기존 design/periodic/mode-network API를 재사용해 objective→parameterization→optimizer→history→resume→final evaluation의 최소 고수준 인터페이스를 통합한다 | IMPLEMENTED | VERIFIED | `20260923T144401Z-g6-05-a68f0a36` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-06 | density filter, projection, beta continuation, symmetry, mask, min linewidth/gap, fabrication perturbation, binary export를 실제 검사와 연결한다 | IMPLEMENTED | VERIFIED | `20260923T144533Z-g6-06-88b66961` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-07 | export된 binary/GDS 구조를 다시 import하여 독립 finer forward로 평가한다 | IMPLEMENTED | VERIFIED | `20260923T150735Z-g6-07-59a56247` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-08 | low-intensity/near-zero reference/frequency cutoff/evanescent/backflow에서 NaN·음의 국소 flux·invalid phase를 임의 clipping으로 숨기지 않는다 | IMPLEMENTED | VERIFIED | `20260923T150754Z-g6-08-7959b749` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G8-01 | 기존 Project JSON/NPZ compatibility와 schema migration을 시험한다 | IMPLEMENTED | VERIFIED | `20260923T150820Z-g8-01-333cab45` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-02 | 큰 결과의 chunked/lazy read가 필요하면 HDF5 또는 Zarr 중 요구에 맞는 한 구현을 우선 채택한다 | IMPLEMENTED | VERIFIED | `20260923T150845Z-g8-02-c067cfaa` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-03 | GUI의 CAD/GDS → material/source/boundary → 실제 mesh preview → resource preflight → job queue → cancel/resume → 결과 overlay → 데이터/GDS export 경로를 E2E로 시험한다. | IMPLEMENTED | VERIFIED | `20260923T150854Z-g8-03-c49426ec` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-04 | geometry 편집의 undo/redo, copy/multiselect, autosave/recovery, versioned project, 구조/parameter 단위 검증과 결과 stale 표시를 구현/확인한다 | IMPLEMENTED | VERIFIED | `20260923T150911Z-g8-04-e63a91d7` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-05 | 최종 wheel에 frontend 정적 자산을 포함하고 최종 사용자가 Node/npm이나 저장소 checkout 없이 UI를 실행하도록 한다 | IMPLEMENTED | VERIFIED | `20260923T150929Z-g8-05-df10799c` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-06 | 지원 Python/Torch/CuPy/runtime 최소·최대 버전을 실제 설치 시험으로 확정한다 | IMPLEMENTED | VERIFIED | `20260923T150958Z-g8-06-c67e2b4b` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-07 | README의 모든 기본 예제를 installed wheel에서 실행한다 | IMPLEMENTED | VERIFIED | `20260923T151019Z-g8-07-3a10d8bd` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |

### G9 보안·운영·출고 판정 (WORKSTATION, P0)

| Task | Title | Implementation | Verification | Newest run | Source commit | Judgement | Reason |
| --- | --- | --- | --- | --- | --- | --- | --- |
| G9-01 | local server의 loopback 기본값, origin/host 검증, 허용된 파일 경로, 업로드 크기, path traversal, 악성/손상 JSON/NPZ/GDS, 압축 폭탄과 unsafe pickle을 검사한다 | IMPLEMENTED | VERIFIED | `20260923T151044Z-g9-01-aa27ac1c` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G9-02 | 코드와 번들 데이터의 출처·license·third-party notices·SBOM·dependency/security scan을 수행한다 | IMPLEMENTED | VERIFIED | `20260923T151127Z-g9-02-cc54d6f5` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G9-03 | RELEASE_REVIEW의 미해결 계약/배포 질문을 실제 문서에 따라 추적한다 | NOT_ASSESSED | NOT_RUN | none | none | FAIL | verification_state is NOT_RUN |
| G9-04 | API stability/deprecation, project/result/checkpoint version compatibility, changelog, 알려진 한계, bug template, minimal repro, numerical bug severity, release rollback/결과 영향 공지를 준비한다. | IMPLEMENTED | VERIFIED | `20260923T151152Z-g9-04-a75f3c5b` | `aa3f8c1506b5` | PASS | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G9-06 | 최종 release candidate의 정확한 source tree와 wheel에서 전체 필수 gate를 실행한다 | IN_PROGRESS | VERIFIED | `20260923T162502Z-g9-06-c90ef9ab` | `47bd8ace3e69` | PASS | evidence matches the current checkout |
...
| --- | --- | --- |
| rtx3060-win11-lab | G4-01 `20260923T142145Z-g4-01-425ce442` (platform_id); G4-02 `20260923T142227Z-g4-02-69c5dfbc` (platform_id); G4-03 `20260923T142248Z-g4-03-3fc0fde3` (platform_id); G4-04 `20260923T142320Z-g4-04-c438e262` (platform_id); G4-05 `20260923T142650Z-g4-05-e0edcc9e` (platform_id); G4-06 `20260923T142707Z-g4-06-c173d093` (platform_id) | 63 |
...
Newest record `20260923T112904Z-86b61a54.json` (kind `clean_install_record`), taken at commit `86b61a543091` on 2026-09-23T11:29:04+00:00 with 0 dirty packaging paths; all steps passed: yes.

Wheel `torchfdtd-0.15.0-py3-none-any.whl`, SHA-256 `28a83fea97ff71ac6732ec0eeacfde58b816bc79ca2578f5b63a1254ed67a535`, 968,615 bytes, 159 entries, 152 package files; browser assets match the committed ones: yes; frontend assets current: yes.
...
| Step | Status | Seconds |
| --- | --- | --- |
| build_wheel | passed | 17.87 |
| cpu_venv_create | passed | 13.95 |
| cpu_pip_install_torch | passed | 96.83 |
| cpu_pip_install_wheel | passed | 57.6 |
| cpu_package_list | passed | 1.69 |
| cpu_import_run_save_load | passed | 11.26 |
| cpu_server_index_assets_api | passed | 7.27 |
| cpu_doctor | passed | 5.73 |
| cuda_venv_create | passed | 13.57 |
| cuda_pip_install_torch | passed | 159.11 |
| cuda_pip_install_wheel_extras | passed | 61.5 |
| cuda_package_list | passed | 1.07 |
| cuda_fused_forward_run | passed | 18.29 |
| cuda_doctor | passed | 5.43 |
| readme_examples | passed | 19.36 |
...
| G3-06 | PEC/PMC cavity eigenfrequency, symmetry-reduced versus full domain, and gradient mapping | none (the test assertions are the record) | the pass/fail assertions of the required tests | 93 passed, 0 failed, 0 skipped in `20260923T133125Z-g3-06-8f106f4b` | VERIFIED |
...
| G3-09 | Mode solver effective index, field, confinement and power against analytic slab and fiber oracles | none (the test assertions are the record) | the pass/fail assertions of the required tests | 32 passed, 0 failed, 0 skipped in `20260923T140645Z-g3-09-1415252b` | VERIFIED |
| G3-10 | PIC mode-port networks: straight guide, discontinuity, Y branch and crossing S, reciprocity, passivity with the radiation defect measured | none (the test assertions are the record) | the pass/fail assertions of the required tests | 23 passed, 0 failed, 0 skipped in `20260923T141102Z-g3-10-3d8a3f19` | VERIFIED |
| G3-11 | Dipole radiation: near-to-far and near-zone projection against analytic Hertzian fields, native far-field pattern convergence | none (the test assertions are the record) | the pass/fail assertions of the required tests | 56 passed, 0 failed, 0 skipped in `20260923T141130Z-g3-11-0f66eb2a` | VERIFIED |
| G3-12 | Tensor dielectrics: eigenpolarization dispersion, birefringent slab transmission and tensor gradients | none (the test assertions are the record) | the pass/fail assertions of the required tests | 45 passed, 0 failed, 0 skipped in `20260923T141435Z-g3-12-d81a898c` | VERIFIED |
...
| G3-14 | Small discrete problems: CPU torch, CUDA torch, fused CUDA, streamed and reversible forward and VJP agreement | none (the test assertions are the record) | the pass/fail assertions of the required tests | 75 passed, 0 failed, 0 skipped in `20260923T141920Z-g3-14-daa944f0` | VERIFIED |
| G3-15 | Full-autograd oracle, explicit adjoint, central-difference step sweep, Taylor remainder and directional VJP checks | none (the test assertions are the record) | the pass/fail assertions of the required tests | 34 passed, 0 failed, 0 skipped in `20260923T142013Z-g3-15-20b354d0` | VERIFIED |
| G3-16 | Physical shape and material parameter gradients: slab thickness and permittivity against the Airy derivative, polygon vertices under mesh refinement | none (the test assertions are the record) | the pass/fail assertions of the required tests | 19 passed, 0 failed, 0 skipped in `20260923T142107Z-g3-16-afd7ad6e` | VERIFIED |
| G3-17 | Oracle independence, precision floor, time-window and PML error budgets of every G3 fixture | none (the test assertions are the record) | the pass/fail assertions of the required tests | 4 passed, 0 failed, 0 skipped in `20260923T142121Z-g3-17-ce8e7971` | VERIFIED |
...
| G3-04 | evidence was recorded on a dirty tree (1 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-06 | evidence was recorded on a dirty tree (2 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-07 | evidence was recorded on a dirty tree (2 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-08 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-09 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-10 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-11 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-12 | evidence was recorded on a dirty tree (4 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-13 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G3-14 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-15 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-16 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G3-17 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-01 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-02 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-03 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-04 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-05 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G4-06 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-01 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-02 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-03 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-04 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-05 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-06 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-07 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-08 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-09 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G5-10 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-01 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-02 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-03 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-04 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
...
| G6-05 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-06 | evidence was recorded on a dirty tree (5 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-07 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G6-08 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-01 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-02 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-03 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-04 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-05 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-06 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G8-07 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G9-01 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G9-02 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
| G9-04 | evidence was recorded on a dirty tree (11 paths); it is not tied to commit aa3f8c1506b5 alone |
