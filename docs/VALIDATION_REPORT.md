...
| G9-02 | 코드와 번들 데이터의 출처·license·third-party notices·SBOM·dependency/security scan을 수행한다 | IMPLEMENTED | VERIFIED | `20260922T051942Z-g9-02-9b6000ae` | `6eb168b3f601` | FAIL | STALE: test source changed since the run: tests/test_provenance_inventory.py |
