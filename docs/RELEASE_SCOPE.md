...
| G9 | 보안·운영·출고 판정 | WORKSTATION | 7 | 4 | 0 | 2 | 0 | 4 pass, 2 fail |
| H1 | 실제 단일 문제 multi-GPU | HPC | 6 | 0 | 0 | 1 | 5 | 0 pass, 6 fail |

- WORKSTATION (stages G0, G1, G2, G3, G4, G5, G6, G7, G8, G9): 68 of 76 required tasks pass the judge, 8 fail, and G9-07 (this report) is judged after the render; NOT RELEASABLE.
- HPC (stages G0, G1, G2, G3, G4, G5, G6, G7, G8, G9, H1): 68 of 82 required tasks pass the judge, 14 fail, and G9-07 (this report) is judged after the render; NOT RELEASABLE.
<!-- stage-status:end -->
