...
| Beyond VRAM | Ten-step capacity gates only: 2.42 billion cells with 54 GiB of FP32 E/H and a full material gradient, and a 2.26 billion cell crash-and-resume run, both on the RTX 5880 ([BEYOND_VRAM_FP32.md](BEYOND_VRAM_FP32.md), [BEYOND_VRAM_RESTART.md](BEYOND_VRAM_RESTART.md)). A meaningful physical-duration case is still required and is not replaced by these gates; the 120 um pillar-lens case is declared ([cases/G5-05.json](validation/cases/G5-05.json), [G5-06.json](validation/cases/G5-06.json)), rehearsed on the RTX 3060 ([BEYOND_VRAM_PROPAGATED.md](BEYOND_VRAM_PROPAGATED.md)) and awaits its RTX 5880 run; its E/H state is below physical VRAM and only its live adjoint state above it | NOT_RUN (G5-05, G5-06) |
