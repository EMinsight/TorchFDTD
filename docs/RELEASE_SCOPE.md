...
- WORKSTATION (stages G0, G1, G2, G3, G4, G5, G6, G7, G8, G9): 62 of 76 required tasks pass the judge, 14 fail, and G9-07 (this report) is judged after the render; NOT RELEASABLE.
- HPC (stages G0, G1, G2, G3, G4, G5, G6, G7, G8, G9, H1): 62 of 82 required tasks pass the judge, 20 fail, and G9-07 (this report) is judged after the render; NOT RELEASABLE.
<!-- stage-status:end -->
