...
Complex CPML memories participate in checkpoint replay. The implemented complex
resident path uses explicit Torch operations on CPU or CUDA. Real-only fused
kernels and spatial slab streaming are not used for this complex path.
...
and replay. The adjoint transpose still uses Torch operations. Tests compare
...
This does not implement complex spatial streaming or a fused complex adjoint.
