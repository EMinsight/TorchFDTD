...
This forward kernel does not implement complex spatial streaming.
...
VJPs with complex checkpoint replay. It does not supply complex spatial
streaming, dispersive derivatives or trainable Bloch phases.
