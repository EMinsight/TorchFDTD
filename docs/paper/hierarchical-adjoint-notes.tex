...
credited before release and no partially executed solve is retried. This
repair requires a fresh large-grid validation. Cache release can synchronize
the process and its time belongs to the calling operation.
