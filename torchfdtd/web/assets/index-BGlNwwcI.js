 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hd=["svg",mt,[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jd=["svg",mt,[["circle",{cx:"12",cy:"12",r:"10"}],["circle",{cx:"12",cy:"12",r:"1"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wd=["svg",mt,[["circle",{cx:"12",cy:"12",r:"10"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function Vl(){return new ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:jo(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function jl(){return new ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jo(),fragmentShader:`
...
`].filter(vs).join(`
`)),r=Co(r),r=nc(r,t),r=ic(r,t),o=Co(o),o=nc(o,t),o=ic(o,t),r=sc(r),o=sc(o),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+f);const E=w+m+r,y=w+f+o,T=Ql(s,s.VERTEX_SHADER,E),b=Ql(s,s.FRAGMENT_SHADER,y);s.attachShader(_,T),s.attachShader(_,b),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function M(A){if(n.debug.checkShaderErrors){const I=s.getProgramInfoLog(_)||"",P=s.getShaderInfoLog(T)||"",O=s.getShaderInfoLog(b)||"",N=I.trim(),z=P.trim(),B=O.trim();let G=!0,K=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(G=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,T,b);else{const ue=tc(s,T,"vertex"),_e=tc(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
<input id="file-input" type="file" accept=".json,.fsp" hidden><dialog id="dialog"><div id="dialog-content"></div></dialog><div id="toast" role="alert" hidden></div>`;function ns(){gu({icons:p0,attrs:{"stroke-width":1.65}})}function at(n,e="info"){Dr.push({text:n,kind:e,time:new Date().toLocaleTimeString("en-GB")}),he("#messages").innerHTML=Dr.slice(-100).map(t=>`<div class="log ${t.kind}"><time>${t.time}</time><span>${$e(t.text)}</span></div>`).join(""),he("#messages").scrollTop=he("#messages").scrollHeight,he("#log-count").textContent=Dr.length}function Pt(n){he("#toast").textContent=n,he("#toast").hidden=!1,setTimeout(()=>he("#toast").hidden=!0,5e3)}async function bt(n,e){var i;const t=await fetch("/api"+n,e===void 0?{}:{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){let s;try{s=await t.json()}catch{throw Error(`Server returned ${t.status}`)}throw Error(Array.isArray(s.detail)?s.detail.map(a=>a.loc.join(".")+": "+a.msg).join(`
`):s.detail||`Server returned ${t.status}`)}return(i=t.headers.get("content-type"))!=null&&i.includes("json")?t.json():t.text()}function Ec(){return[...D.project.structures,...D.project.sources,...D.project.monitors].find(n=>n.id===D.selected)}function f0(n){return D.project.structures.some(e=>e.id===n)?"structures":D.project.sources.some(e=>e.id===n)?"sources":"monitors"}function dt(){D.history.push(JSON.stringify(D.project)),D.history.length>80&&D.history.shift(),D.future=[]}function rt(){D.dirty=!0,D.maxRevision=Math.max(D.maxRevision,D.project.revision||0)+1,D.project.revision=D.maxRevision,D.project.content_sha256=null,Ad()||(Pt("Browser storage is full. Use Save to keep this project before closing or reloading."),at("Automatic browser save failed. Export this project with Save to retain the current settings.","warning"))}function m0(n,e,t=!0){Object.assign([...D.project.structures,...D.project.sources,...D.project.monitors].find(i=>i.id===n)||{},e),t&&(rt(),Ut(),qt(),Qe())}function Jn(){return D.multi.length?D.multi:D.selected==="fdtd"?[]:[D.selected]}function kn(n,e=!1){if(e&&n!=="fdtd"){const t=new Set(Jn());t.has(n)?t.delete(n):t.add(n),D.multi=[...t],D.selected=D.multi.at(-1)||"fdtd"}else D.multi=n==="fdtd"?[]:[n],D.selected=n;qt(),Ut(),tt==null||tt.render()}function wc(n){D.multi=n.length>1?[...n]:[],D.selected=n.at(-1)||"fdtd",qt(),Ut(),tt==null||tt.render()}function Ro(){const n=!!D.results&&(D.planHash===null||D.results.plan_hash!==D.planHash);he("#stale-banner").hidden=!n,he("#stale-banner").textContent=n?`Stale results: the project changed since run revision ${D.results.revision??"?"} (plan hash differs). Run again for current results.`:"",he("#results-tree").classList.toggle("stale",n),he("#field-view").classList.toggle("stale",n),D.tab==="fields"&&An()}function Ad(){try{return localStorage.setItem("torchfdtd.project.v1",JSON.stringify(D.project)),!0}catch{return!1}}function xn(n){D.mode=n,he("#mode-badge").textContent=n.toUpperCase(),he("#mode-badge").className="mode-badge "+n,ii(".editable").forEach(e=>e.disabled=n!=="layout"),he("#run-button").disabled=n!=="layout",he("#stop-button").disabled=n!=="running",he("#layout-button").disabled=n==="running",ii("[data-example]").forEach(e=>e.disabled=n==="running"),Ut(),tt==null||tt.render()}function qt(){const n=D.project;he("#project-title").innerHTML=$e(n.name)+(n.revision?` <small class="revision">rev ${n.revision}</small>`:""),he("#object-count").textContent=n.structures.length+n.sources.length+n.monitors.length+1;const e=new Set(Jn()),t=(i,s,a="")=>`<button class="tree-row ${e.has(i.id)?"selected":""} ${a}" data-select="${$e(i.id)}"><span class="tree-icon">${Ne(s)}</span><span>${$e(i.name)}</span>${i.enabled===!1?"<small>off</small>":""}</button>`;he("#tree").innerHTML=`<div class="tree-root">${Ne("folder-open")} model</div>${t({id:"fdtd",name:"FDTD"},"scan","region-row")}<div class="tree-group">Structures <span>${n.structures.length}</span></div>${n.structures.map(i=>t(i,{rectangle:"box",circle:"cylinder",ring:"circle",sphere:"orbit",polygon:"shapes"}[i.kind])).join("")}<div class="tree-group">Sources <span>${n.sources.length}</span></div>${n.sources.map(i=>t(i,"radio","source-row")).join("")}<div class="tree-group">Monitors <span>${n.monitors.length}</span></div>${n.monitors.map(i=>t(i,"activity","monitor-row")).join("")}`,ns()}function Xe(n,e,t,i="",s={}){var a;return`<label class="property-row"><span>${n}</span><div><input aria-label="${n}" data-path="${e}" data-scale="${s.scale||1}" ${s.reciprocal?`data-reciprocal="${s.reciprocal}"`:""} type="number" value="${Number(((a=t.toPrecision)==null?void 0:a.call(t,12))??t)}" step="${s.step||"any"}" ${s.min!==void 0?`min="${s.min}"`:""}><small>${i}</small></div></label>`}function Lt(n,e,t,i){return`<label class="property-row"><span>${n}</span><select aria-label="${n}" data-path="${e}">${i.map(s=>{const[a,r]=Array.isArray(s)?s:[s,s];return`<option value="${$e(a)}" ${a===t?"selected":""}>${$e(r)}</option>`}).join("")}</select></label>`}function jt(n,e){return`<section class="property-section"><h3>${n}</h3>${e}</section>`}const Ha={resident:"Resident",streamed_host:"Streamed through host memory",streamed_disk:"Streamed through disk",tiled:"Tiled (approximate)"},ya=n=>n==null?"?":n>=2**30?(n/2**30).toFixed(2)+" GiB":(n/2**20).toFixed(1)+" MiB";function Cd(n){if(!n)return"Resolving execution mode…";const e=n.requested==="auto"?"Auto → ":"";if(!n.mode)return`<span class="warning error">${$e(e+(n.error||"no execution mode fits"))}</span>`;const t=(n.warnings||[]).map(i=>`<span class="warning">${$e(i)}</span>`).join("");return`<b>${$e(e+Ha[n.mode])}</b> on ${n.backend==="cuda"?"GPU":"CPU"} · ${$e(n.reason||"")}${n.mode==="streamed_disk"?` · scratch ${$e(n.scratch_directory)}`:""}${t}`}function g0(n){var s,a;if(n.execution_mode!=="tiled")return"";n.tiling??(n.tiling={size_um:20,overlap_um:2,max_angle_deg:45,propagation_um:null});const e=n.tiling,t=(a=(s=lt==null?void 0:lt.execution)==null?void 0:s.tiled)==null?void 0:a.plan,i=t==null?void 0:t.suggestion;return'<div class="tiled-panel">'+Xe("tile size","tiling.size_um",e.size_um,"µm",{min:.001})+Xe("tile overlap","tiling.overlap_um",e.overlap_um,"µm",{min:.001})+Xe("max diffraction angle","tiling.max_angle_deg",e.max_angle_deg,"°",{min:0})+`<div class="static-row">suggested overlap <b id="tiled-suggestion">${i?`${i.overlap_um.toPrecision(3)} µm = ${i.spread_um.toPrecision(3)} spread + ${i.absorber_um.toPrecision(3)} absorber`:"validate to compute"}</b></div><label class="enabled-row"><input type="checkbox" aria-label="Propagate to a focal plane" data-tiled-propagate ${e.propagation_um!=null?"checked":""}> Propagate to a focal plane</label>`+(e.propagation_um!=null?Xe("propagation distance","tiling.propagation_um",e.propagation_um,"µm",{min:0}):"")+'<p class="property-help">Approximate overlapping tiles for planar devices that fit no memory tier: one soft sheet source spanning the device (tick “extend through PML” on the sheet), CPML on every face and exactly one frequency plane, the output plane. Each tile misses the scatterers beyond its overlap, so read the mismatch indicator of the finished run and compare overlaps; the suggested overlap is distance × tan(angle) plus the absorber. The optional focal plane is an angular-spectrum propagation of the stitched plane. Point, one-way and TFSF sources, Bloch phases and graded meshes are rejected; the tiled adjoint is Python only. See docs/TILED_STITCHING.md.</p></div>'}function _0(n){var s,a,r,o,l;if(!(n!=null&&n.mode))return"";const e=n.policy,t=n.reservation;let i=$e(Ha[n.mode]||n.mode);if(n.mode==="resident"&&(i+=` · estimate ${ya((s=n.resident)==null?void 0:s.estimated_bytes)}`),e&&(i+=` · slab ${e.slab_width} × depth ${e.temporal_depth} · ${e.state_storage==="disk"?"file banks":"DRAM banks"} · ${e.tile_device==="cuda"?"GPU tiles":"CPU tiles"}`),t&&(i+=`<br>host ${ya(t.host_reservation_bytes)}${(e==null?void 0:e.tile_device)==="cuda"?` · GPU ${ya(t.gpu_reservation_bytes)}`:""}${t.disk_reservation_bytes?` · disk ${ya(t.disk_reservation_bytes)}`:""}`),n.mode==="streamed_disk"&&(i+=`<br>scratch ${$e(n.scratch_directory)}`),((a=n.report)==null?void 0:a.forward_seconds)!=null&&(i+=`<br>${n.report.forward_seconds.toFixed(2)} s streamed forward`),n.mode==="tiled"&&((r=n.tiled)!=null&&r.plan)){const c=n.tiled.plan,d=n.indicator,u=h=>h==null?"n/a":h.toFixed(3);i+=` · ${c.tiles} tiles (${c.counts.join(" × ")}) of ${c.tile_um.toPrecision(3)} µm · overlap ${c.overlap_um.toPrecision(3)} µm${c.propagation?` · focal plane +${c.propagation.distance_um} µm`:""}`,d&&(i+=`<br><b class="indicator">max mismatch ${u(d.max_mismatch_center)}</b> (centre) · ${u(d.max_mismatch)} (full band)`),(l=(o=n.report)==null?void 0:o.pairs)!=null&&l.length&&(i+=`<table class="mismatch-table"><thead><tr><th>pair</th><th>axis</th><th>mismatch</th><th>centre</th></tr></thead><tbody>${n.report.pairs.map(h=>`<tr><td>${$e(h.tiles[0].replace("tile-",""))} | ${$e(h.tiles[1].replace("tile-",""))}</td><td>${$e(h.axis)}</td><td>${u(h.mismatch)}</td><td>${u(h.mismatch_center)}</td></tr>`).join("")}</tbody></table><p class="mismatch-note">Neighbour disagreement inside the shared overlap: the error indicator of an approximate method, not the error against the whole device.</p>`)}return"<br>"+i}function Ut(){var s,a;if(!D.project)return;const n=D.project,e=Ec(),t=n.region;he("#property-type").textContent=D.multi.length>1?"selection":e?e.kind||"monitor":"solver";let i="";if(D.multi.length>1){const r=D.multi.map(o=>[...n.structures,...n.sources,...n.monitors].find(l=>l.id===o)).filter(Boolean);i=`<div class="object-title">${Ne("copy")}<div><strong>${r.length} objects selected</strong><small>Ctrl+click adds to or removes from the selection</small></div></div>`+jt("Selection",`<ul class="multi-list">${r.map(o=>`<li>${$e(o.name)} <small>${$e(o.kind||"monitor")}</small></li>`).join("")}</ul><div class="dialog-buttons"><button data-action="duplicate">Duplicate all</button><button data-action="copy">Copy</button><button data-action="delete">Delete all</button></div><p class="property-help">Duplicate, Copy (Ctrl+C), Paste (Ctrl+V) and Delete act on every selected object. Select one object to edit its properties.</p>`),he("#properties").innerHTML=`<fieldset ${D.mode!=="layout"?"disabled":""}>${i}</fieldset>`,ns();return}if(e){const r=f0(e.id),o=r==="structures",l=r==="sources";i=`<div class="object-title">${Ne(o?"box":l?"radio":"activity")}<div><strong>${$e(e.name)}</strong><small>${o?e.kind:l?e.kind+" source":e.kind==="field"?"Frequency / flux monitor":"Point time monitor"}</small></div></div><label class="property-row name-row"><span>name</span><input aria-label="name" data-path="name" value="${$e(e.name)}"></label><label class="enabled-row"><input type="checkbox" data-path="enabled" ${e.enabled?"checked":""}> Enabled in simulation</label>`;const c=e.kind==="field"?[0,1,2].filter(d=>d!=="xyz".indexOf(e.normal)&&(t.dimension==="3d"||d<2)):e.kind==="tfsf"?[0,1,2].filter(d=>t.dimension==="3d"||d<2):e.kind==="rectangle"||e.kind==="plane"?[0,1,2]:["circle","ring","polygon"].includes(e.kind)?[2]:[];if(i+=jt("Geometry",e.center.map((d,u)=>Xe("xyz"[u],"center."+u,d,"µm")).join("")+c.map(d=>Xe("xyz"[d]+" span","size."+d,e.size[d],"µm",{min:o?.001:0})).join("")+(["circle","sphere","ring"].includes(e.kind)?Xe("radius","radius",e.radius,"µm",{min:.001}):"")+(e.kind==="ring"?Xe("inner radius","inner_radius",e.inner_radius,"µm",{min:0}):"")+(o?kv(e,Xe):"")),o&&(i+=jt("Material",Lt("material","material",e.material,n.materials.map(d=>d.name))+`<div class="static-row">refractive index <b>${(((s=n.materials.find(d=>d.name===e.material))==null?void 0:s.model)||"dielectric")==="dielectric"?(a=n.materials.find(d=>d.name===e.material))==null?void 0:a.index:"dispersive"}</b></div>`+Xe("mesh order","mesh_order",e.mesh_order,"",{step:1,min:1})+'<p class="property-help">Lower order takes priority in overlaps. Open Materials to edit dielectric, Drude or Lorentz parameters and inspect n/k.</p>'),i+=jt("Rotation",Bv(e,Xe,Lt))),o){const d=n.structures.findIndex(u=>u.id===e.id);i+=jt("Structure order",`<button data-action="structure-earlier" ${d===0?"disabled":""}>Move earlier in tree</button><button data-action="structure-later" ${d===n.structures.length-1?"disabled":""}>Move later in tree</button><p class="property-help">When mesh orders are equal, the later structure takes priority in overlaps.</p>`)}if(l){e.time_definition??(e.time_definition="cycles"),e.pulse_length??(e.pulse_length=2e-14),e.pulse_offset??(e.pulse_offset=5e-14),e.phase??(e.phase=0);const d=e.use_global_source?n.global_source:e;i+=jt("Source settings",Yv(e,t,Xe,Lt)+Xv(e,Xe,Lt)+`<label class="enabled-row"><input type="checkbox" data-path="use_global_source" ${e.use_global_source?"checked":""} ${n.global_source?"":"disabled"}> Use global source settings</label><button data-action="global-source">Edit global source settings</button>${n.global_source?"":'<p class="property-help">Imported global settings are unavailable. Configure them before enabling inheritance.</p>'}`+(d?`<fieldset ${e.use_global_source?"disabled":""}>`+Md(d,Xe,Lt)+'<button data-action="source-signal">Load / edit time signal</button></fieldset>':"")+Xe("phase","phase",e.phase,"deg")+Xe("amplitude","amplitude",e.amplitude,"",{min:.001})+`<button data-action="source-preview">Preview time signal / spectrum</button><p class="property-help">${e.kind==="tfsf"?"Closed box with six-face E/H corrections and a live incident Yee line. Source preview shows the incident field at the entry face.":e.injection==="oneway"?"Normal-incidence discrete E/H plane with an eight-cell incident-line delay. Amplitude scales the incident-line soft drive. Source preview includes both corrections.":e.kind==="plane"?"Bidirectional E/H sheet. Bloch axes apply the unit-cell phase across the sheet.":"Reduced electric or magnetic point excitation. Magnetic sources use the H half-step time. Vector orientation may excite both 2D polarizations."}</p>`)}if(!o&&!l){e.spectrum??(e.spectrum={sampling:"fft",wavelength_start:1.3,wavelength_stop:1.8,frequency_points:101,apodization:"hann",apodization_center:2e-14,apodization_time_width:1e-14});const d=e.use_global_monitor?n.global_monitor:e.spectrum,u=e.use_global_monitor&&e.inherit_apodization!==!1,h=u?d:e.spectrum;i+=jt("Monitor settings",(e.kind==="field"?r0(e,t,Xe,Lt):Lt("component","component",e.component,["Ex","Ey","Ez","Hx","Hy","Hz"])+'<p class="property-help">Records one Yee field component at every time step. DFT downsampling affects spectral processing only.</p>')+Xe("DFT time downsample","time_downsample",e.time_downsample||1,"",{min:1,step:1})+`<label class="enabled-row"><input type="checkbox" data-path="use_global_monitor" ${e.use_global_monitor?"checked":""}> Use global monitor settings</label>${e.use_global_monitor?`<label class="enabled-row"><input type="checkbox" data-path="inherit_apodization" ${u?"checked":""}> Inherit global apodization</label>`:""}<button data-action="global-monitor">Edit global monitor settings</button>`),i+=jt("Frequency / wavelength",`<fieldset ${e.use_global_monitor?"disabled":""}>`+wd(d,Xe,Lt,{plane:e.kind==="field"})+'</fieldset><p class="property-help">DFT values are unnormalized field integrals. Power ratios require a matching air reference.</p>'),i+=jt("Apodization",`<fieldset ${u?"disabled":""}>`+Lt("apodization","spectrum.apodization",h.apodization,[["none","None"],["start","Start"],["end","End"],["full","Full"],...e.kind==="field"?[]:[["hann","Hann (legacy FFT)"]]])+(["start","end","full"].includes(h.apodization)?Xe("apodization center","spectrum.apodization_center",h.apodization_center*1e15,"fs",{min:0,scale:1e-15})+Xe("apodization time width","spectrum.apodization_time_width",h.apodization_time_width*1e15,"fs",{min:.001,scale:1e-15})+'<p class="property-help">Width is the intensity FWHM of the Gaussian window. Apodized spectra are not normalized transmission or absolute intensity.</p>':"")+"</fieldset>")}}else{i=`<div class="object-title">${Ne("scan")}<div><strong>FDTD</strong><small>Simulation region</small></div></div>`;const r=t.backend==="cuda"||t.backend==="auto"&&!!(vt!=null&&vt.cuda),o=vt!=null&&vt.cuda?vt.cupy?"CUDA with fused Yee / CPML and plane DFT kernels":"CUDA with PyTorch kernels. Install the cuda-kernels extra for fused kernels.":"No CUDA device reported by the solver";i+=jt("General",`<label class="enabled-row switch-row" title="${$e(o)}"><input type="checkbox" aria-label="GPU" data-gpu-switch ${r?"checked":""} ${vt!=null&&vt.cuda?"":"disabled"}> GPU <small>${$e(vt!=null&&vt.cuda?vt.cupy?"fused CUDA kernels":"PyTorch CUDA kernels":"no CUDA device")}</small></label>`+Lt("dimension","dimension",t.dimension,[["2d","2D (XY)"],["3d","3D"]])+Lt("memory","execution_mode",t.execution_mode||"auto",[["auto","Auto (recommended)"],["resident","Resident (GPU or CPU memory)"],["streamed_host","Streamed through host memory (DRAM)"],["streamed_disk","Streamed through disk"],["tiled","Tiled (approximate, large devices)"]])+`<div class="execution-status" id="execution-status">${Cd(lt==null?void 0:lt.execution)}</div><p class="property-help">Auto runs resident when the estimate fits 75% of free GPU memory (80% of host memory on CPU) and at most 8 million cells; otherwise it streams x slabs through DRAM field banks, then through scratch files on disk. Streamed jobs are forward only: point monitors, frequency planes and one field snapshot at the final step, no live frames, no decay shutoff, no dispersive, TFSF, subpixel or PMC scenes. Expect streaming to run several times slower than resident. See docs/EXECUTION_MODES.md.</p>`+g0(t)+`<div class="advanced-execution ${D.advancedExecution?"open":""}"><button type="button" class="advanced-toggle" data-advanced-toggle aria-expanded="${!!D.advancedExecution}">Advanced execution</button><div class="advanced-body" ${D.advancedExecution?"":"inert"}>`+Lt("resource","backend",t.backend,[["auto","GPU if available"],["cuda","GPU · CUDA"],["cpu","CPU"]])+Lt("precision","precision",t.precision,["float32","float64"])+Lt("CUDA kernel","cuda_kernel",t.cuda_kernel||"torch",[["torch","PyTorch reference"],["fused","Fused Yee / CPML (experimental)"]])+Lt("Frequency monitor kernel","cuda_monitor_kernel",t.cuda_monitor_kernel||"torch",[["torch","PyTorch reference"],["fused","Shared CUDA plane DFT (experimental)"]])+'<p class="property-help">The GPU switch sets these together: on selects CUDA with fused kernels when CuPy is installed, off selects CPU. Streamed GPU tiles always use the fused kernels.</p></div></div>'),i+=jt("Geometry",t.size.map((l,c)=>Xe("xyz"[c]+" span","size."+c,l,"µm",{min:.01})).join("")),i+=jt("Mesh settings",Iv(t,Xe,Lt,$e)),i+=jt("Boundary conditions",Xe("PML layers","pml_cells",t.pml_cells,"cells",{step:1,min:3})+["x","y",...t.dimension==="3d"?["z"]:[]].map((l,c)=>["min","max"].map(u=>{const h=l+"_"+u,p=t.boundaries[h];return Lt(l+" "+u+" bc","boundaries."+h+".kind",p.kind,[["pml","PML"],["periodic","Periodic"],["bloch","Bloch"],["pec","PEC"],["antisymmetric","Anti-symmetric (PEC)"],["pmc","PMC"],["symmetric","Symmetric (PMC)"]])+(p.kind==="pml"?`<details class="boundary-options"><summary>${l} ${u} PML settings</summary>${Xe(l+" "+u+" layers","boundaries."+h+".layers",p.layers??t.pml_cells,"cells",{step:1,min:3})}<label class="enabled-row"><input type="checkbox" data-boundary-default="${h}" ${p.layers===null?"checked":""}> Use default layers</label>${Xe("sigma scale","boundaries."+h+".sigma_scale",p.sigma_scale)}${Xe("kappa","boundaries."+h+".kappa",p.kappa)}${Xe("alpha","boundaries."+h+".alpha",p.alpha)}${Xe("polynomial","boundaries."+h+".polynomial",p.polynomial)}${Xe("alpha polynomial","boundaries."+h+".alpha_polynomial",p.alpha_polynomial)}</details>`:"")}).join("")+(t.boundaries[l+"_min"].kind==="bloch"?Xe("Bloch phase "+l,"bloch_phase."+c,t.bloch_phase[c],"rad"):"")).join("")+Xe("background index","background_index",t.background_index,"",{min:1})+'<button data-action="boundary-editor">Edit six faces together</button><p class="property-help">Cyclic boundaries are paired. Bloch phase is the phase gained over one positive unit-cell translation. PMC and magnetic symmetry support PEC/PMC walls or restricted endpoint CPML with point sources/monitors. Use the six-face editor for the supported CPML profile.</p>'),i+=jt("Simulation time",Xe("dt stability factor","courant_factor",t.courant_factor??.99,"",{min:.01})+Xe("time steps","steps",t.steps,"",{step:1,min:10})+Xe("snapshot every","snapshot_interval",t.snapshot_interval,"steps",{step:1,min:1})),i+=jt("Termination and diagnostics",n0(t,Xe)),i+=jt("Field output",Lt("component","field",t.field,["Ex","Ey","Ez","Hx","Hy","Hz"])+Lt("plane normal","slice_axis",t.slice_axis,t.dimension==="2d"?["z"]:["x","y","z"])+Xe("plane position","slice_position",t.slice_position,"µm")+Lt("field display","complex_display",t.complex_display,[["real","Real"],["imag","Imaginary"],["magnitude","Magnitude"],["phase","Phase (rad)"]]))}he("#properties").innerHTML=`<fieldset ${D.mode!=="layout"?"disabled":""}>${i}</fieldset>`,ns(),x0(),he("#properties").querySelectorAll("[data-path]").forEach(r=>r.addEventListener("change",()=>{var u;if(D.mode!=="layout"||r.type==="number"&&!v0(r))return;dt();const o=Ec()||n.region,l=r.dataset.path.split(".");l[0]==="downsample_xyz"&&!o.downsample_xyz&&(o.downsample_xyz=[o.downsample||1,o.downsample||1,o.downsample||1]);let c=o;for(const h of l.slice(0,-1))c=c[h];const d=r.type==="checkbox"?r.checked:r.type==="number"?r.dataset.reciprocal?Number(r.dataset.reciprocal)/Number(r.value):Number(r.value)*Number(r.dataset.scale||1):r.value;if(l.length===1&&n.sources.includes(o)?Sd(o,l[0],d):c[l.at(-1)]=d,o===t&&l[0]==="mesh_type"&&d==="graded"&&(t.material_sampling="yee",t.mesh_max=Math.max(t.mesh_max,t.mesh)),o===t&&l[0]==="interface_method"&&d==="subpixel"&&(t.material_sampling="yee"),o===t&&l[0]==="mesh_type"&&d!=="explicit"&&(t.mesh_coordinates=null),n.sources.includes(o)&&["injection","normal"].includes(l[0])&&xc(o,t,{boundaries:!0}),o.kind==="field"&&l[0]==="normal"){const h=o.size.indexOf(0),p="xyz".indexOf(d);h!==p&&(o.size[h]=Math.min(1,t.size[h]/2),o.size[p]=0)}if(l.join(".")==="spectrum.sampling"&&d==="custom"&&!((u=o.spectrum.custom_frequencies_hz)!=null&&u.length)&&(o.spectrum.custom_frequencies_hz=[2e14]),l.join(".")==="spectrum.sampling"&&r.value!=="fft"&&o.spectrum.apodization==="hann"&&(o.spectrum.apodization="none"),l.join(".")==="spectrum.sampling"&&d==="fft"&&(o.spectrum.use_source_limits=!1),o===t&&l[0]==="boundaries"&&l[2]==="kind"){const[h,p]=l[1].split("_"),g=r.value,_=h+"_"+(p==="min"?"max":"min");(["periodic","bloch"].includes(g)||["periodic","bloch"].includes(t.boundaries[_].kind))&&(t.boundaries[_].kind=g),g!=="bloch"&&(t.bloch_phase["xyz".indexOf(h)]=0)}o===t&&l[0]==="dimension"&&t.dimension==="2d"&&(t.slice_axis="z",t.slice_position=0,t.bloch_phase[2]=0,t.boundaries.z_min.kind="pml",t.boundaries.z_max.kind="pml",n.sources.forEach(h=>h.center[2]=0),n.monitors.forEach(h=>{h.center[2]=0,h.kind==="field"&&h.normal==="z"&&(h.normal="x",h.size[0]=0,h.size[2]=1)})),o===t&&l[0]==="dimension"&&t.mesh_type==="explicit"&&(t.mesh_type="uniform",t.mesh_coordinates=null),o===t&&["size","mesh","dimension"].includes(l[0])&&n.sources.forEach(h=>xc(h,t)),rt(),qt(),tt.render(),Ut(),Qe()})),he("#properties").querySelectorAll("[data-record-family]").forEach(r=>r.onchange=()=>{if(D.mode!=="layout")return;dt();const o=r.dataset.recordFamily,l=o==="record_fields"?["Ex","Ey","Ez","Hx","Hy","Hz"]:["x","y","z"],c=new Set(e[o]??l);r.checked?c.add(r.value):c.delete(r.value),e[o]=l.filter(d=>c.has(d)),rt(),Ut(),Qe()}),he("#properties").querySelectorAll("[data-source-vector]").forEach(r=>r.onchange=()=>{D.mode==="layout"&&(dt(),e.theta=r.checked?e.component[1]==="z"?0:90:null,e.phi=e.component[1]==="y"?90:0,rt(),Ut(),tt.render(),Qe())}),he("#properties").querySelectorAll("[data-source-family]").forEach(r=>r.onchange=()=>{D.mode==="layout"&&(dt(),e.component=r.value+e.component[1],rt(),Ut(),tt.render(),Qe())}),he("#properties").querySelectorAll("[data-frequency-table]").forEach(r=>r.onchange=()=>{D.mode==="layout"&&(dt(),e.spectrum.custom_frequencies_hz=r.value.trim().split(/[\s,;]+/).filter(Boolean).map(o=>Number(o)*1e12),rt(),Qe())}),he("#properties").querySelectorAll("[data-run-field-limit]").forEach(r=>r.onchange=()=>{D.mode==="layout"&&(dt(),t.run_control.field_limit=r.checked?1e6:null,rt(),Ut(),Qe())}),he("#properties").querySelectorAll("[data-gpu-switch]").forEach(r=>r.onchange=()=>{if(D.mode!=="layout")return;dt();const o=r.checked&&!!(vt!=null&&vt.cupy);t.backend=r.checked?"cuda":"cpu",t.cuda_kernel=o?"fused":"torch",t.cuda_monitor_kernel=o?"fused":"torch",rt(),Ut(),Qe()}),he("#properties").querySelectorAll("[data-tiled-propagate]").forEach(r=>r.onchange=()=>{D.mode==="layout"&&(dt(),t.tiling.propagation_um=r.checked?10:null,rt(),Ut(),Qe())}),he("#properties").querySelectorAll("[data-advanced-toggle]").forEach(r=>r.onclick=()=>{D.advancedExecution=!D.advancedExecution;const o=r.closest(".advanced-execution");o.classList.toggle("open",D.advancedExecution),r.setAttribute("aria-expanded",String(D.advancedExecution)),o.querySelector(".advanced-body").toggleAttribute("inert",!D.advancedExecution)}),he("#properties").querySelectorAll("[data-axis-steps]").forEach(r=>r.onchange=()=>{D.mode==="layout"&&(dt(),t.mesh_steps=r.checked?[t.mesh,t.mesh,t.mesh]:null,r.checked&&(t.material_sampling="yee"),rt(),Ut(),tt.render(),Qe())}),he("#properties").querySelectorAll("[data-fixed-dt]").forEach(r=>r.onchange=()=>{D.mode==="layout"&&(dt(),t.time_step_override=r.checked?((lt==null?void 0:lt.dt_fs)??.01)*5e-16:null,rt(),Ut(),Qe())})}function v0(n){var c,d;const e=n.dataset.reciprocal?Number(n.dataset.reciprocal)/Number(n.value):Number(n.value)*Number(n.dataset.scale||1),t=n.getAttribute("aria-label"),i=((c=n.parentElement.querySelector("small:not(.field-error)"))==null?void 0:c.textContent)||"",s=n.min===""?null:Number(n.min),a=n.max===""?null:Number(n.max);let r=null;n.validity.badInput||n.value.trim()===""||!Number.isFinite(Number(n.value))||!Number.isFinite(e)?r=`${t} must be a finite number${i?" in "+i:""}.`:s!==null&&Number(n.value)<s?r=`${t} must be at least ${s}${i?" "+i:""}.`:a!==null&&Number(n.value)>a&&(r=`${t} must be at most ${a}${i?" "+i:""}.`);const o=n.closest(".property-row");if((d=o==null?void 0:o.querySelector(".field-error"))==null||d.remove(),n.removeAttribute("aria-invalid"),!r)return!0;n.setAttribute("aria-invalid","true");const l=document.createElement("small");return l.className="field-error",l.textContent=r,o==null||o.append(l),Pt(r+" The previous value is kept."),at("Rejected input: "+r,"warning"),!1}function x0(){ii("[data-boundary-default]").forEach(n=>n.onchange=()=>{if(D.mode!=="layout")return;dt();const e=D.project.region;e.boundaries[n.dataset.boundaryDefault].layers=n.checked?null:e.pml_cells,rt(),Ut(),tt.render(),Qe()})}async function Qe(){var n,e,t;try{const i=D.project,s=i.revision;lt=await bt("/validate",i),D.project===i&&D.project.revision===s&&(D.project.content_sha256=lt.content_sha256,Ad()),D.planHash=lt.plan_hash,Ro(),he("#mesh-summary").innerHTML=`<strong>${lt.shape.join(" × ")}</strong><span>${lt.cells.toLocaleString()} cells · ~${Number(lt.estimated_memory_mb).toFixed(1)} MB</span>${lt.mesh_type==="graded"?`<span>${lt.cell_reduction_percent.toFixed(1)}% fewer cells than uniform</span>`:""}<span>Δt ${lt.dt_fs.toFixed(4)} fs · ${lt.duration_fs.toFixed(1)} fs total</span>${lt.warnings.map(l=>`<p class="warning">${$e(l)}</p>`).join("")}`,he("#footer-grid").textContent=lt.shape.join(" × ")+" cells";const a=he("#execution-status");a&&(a.innerHTML=Cd(lt.execution));const r=he("#tiled-suggestion"),o=(t=(e=(n=lt.execution)==null?void 0:n.tiled)==null?void 0:e.plan)==null?void 0:t.suggestion;return r&&o&&(r.textContent=`${o.overlap_um.toPrecision(3)} µm = ${o.spread_um.toPrecision(3)} spread + ${o.absorber_um.toPrecision(3)} absorber`),!0}catch(i){return D.planHash=null,Ro(),he("#mesh-summary").innerHTML=`<p class="warning error">${$e(i.message)}</p>`,!1}}function y0(n){var s;if(D.mode!=="layout"||!D.project||!tt)return;dt();const e=crypto.randomUUID(),t={id:e,name:n+"_"+(D.project.structures.length+D.project.sources.length+D.project.monitors.length+1),center:[0,0,0],enabled:!0};if(["rectangle","circle","ring","sphere","polygon"].includes(n))D.project.structures.push($a({...t,kind:n,size:[1,1,.5],radius:.5,inner_radius:.3,rotation:0,material:((s=D.project.materials.find(a=>a.name.startsWith("SiN")))==null?void 0:s.name)||D.project.materials[0].name,mesh_order:2}));else if(n==="field")D.project.monitors.push({...t,kind:"field",component:"Ez",normal:"x",size:[0,Math.min(1,D.project.region.size[1]/3),D.project.import_provenance&&D.project.region.dimension==="2d"?1:Math.min(1,D.project.region.size[2]/3)],downsample:1,use_global_monitor:!1,spectrum:{sampling:"frequency",wavelength_start:1.3,wavelength_stop:1.8,frequency_points:41,apodization:"none",apodization_center:2e-14,apodization_time_width:1e-14}});else if(n==="monitor")D.project.monitors.push({...t,component:"Ez",...D.project.import_provenance?{spectrum:{sampling:"fft",apodization:"none"}}:{}});else if(n==="tfsf"){const a=D.project.region,r=a.dimension==="2d"?2:3,o=a.size.map((l,c)=>c>=r?0:Math.max(3*a.mesh,Math.min(2,l-2*(Math.max(a.boundaries["xyz"[c]+"_min"].layers??a.pml_cells,a.boundaries["xyz"[c]+"_max"].layers??a.pml_cells)+3)*a.mesh)));D.project.sources.push({...t,kind:n,injection:"oneway",normal:"x",direction:"+",size:o,component:"Ez",wavelength:1.55,amplitude:1,pulse:"gaussian",pulse_cycles:3,incident_pml_cells:96})}else D.project.sources.push({...t,kind:n,size:[0,1,0],component:"Ez",wavelength:1.55,amplitude:1,pulse:"gaussian",pulse_cycles:3});const i=D.project.sources.find(a=>a.id===e);i&&D.project.import_provenance&&Object.assign(i,{time_definition:"standard",pulse_length:2e-14,pulse_offset:5e-14}),rt(),kn(e),Qe(),at("Added "+t.name+". Drag in a viewport or edit its properties.")}function Po(n,e,t="application/json"){const i=URL.createObjectURL(new Blob([n],{type:t})),s=document.createElement("a");s.href=i,s.download=e,s.click(),setTimeout(()=>URL.revokeObjectURL(i),1e3)}function $n(n){D.tab=n,ii("[data-tab]").forEach(e=>e.classList.toggle("active",e.dataset.tab===n)),he("#viewports").hidden=n!=="geometry",he("#field-view").hidden=n!=="fields",n==="geometry"?tt.render():An()}function Rd(n){D.bottom=n,ii("[data-bottom]").forEach(e=>e.classList.toggle("active",e.dataset.bottom===n)),he("#messages").hidden=n!=="messages",he("#python-editor").hidden=n!=="python",n==="python"&&bt("/python",D.project).then(e=>he("#python-editor").value=e).catch(e=>Pt(e.message))}function An(){var l,c,d,u,h,p;const n=D.project.region,e="xyz".indexOf(n.slice_axis);let t=(((c=(l=D.results)==null?void 0:l.summary)==null?void 0:c.actual_size_um)||n.size).filter((g,_)=>_!==e);const i=D.results,s=(i==null?void 0:i.frames[D.frame])||D.liveFrame,a=(h=(u=(d=i==null?void 0:i.summary)==null?void 0:d.execution)==null?void 0:u.frames)==null?void 0:h[D.frame],r=he("#field-view").classList.contains("stale");he("#field-label").textContent=(r?"STALE · ":"")+(a?`${a.label} · ${a.axes.join("").toUpperCase()} plane`:n.field+" · "+n.complex_display+" · "+["YZ","XZ","XY"][e]+" plane"),he("#frame-label").textContent=a?a.plane+" plane":i?i.frames.length?"Step "+i.frame_steps[D.frame]:"No field snapshot":"Live field",a&&(t=a.span_um),he("#frame-slider").max=Math.max(0,((i==null?void 0:i.frames.length)||1)-1),he("#frame-slider").value=D.frame;const o=D.monitors||[];o.some(g=>g.id===D.plotMonitor)||(D.plotMonitor=(p=o[0])==null?void 0:p.id),he("#plot-monitor").innerHTML=o.map(g=>`<option value="${$e(g.id)}" ${g.id===D.plotMonitor?"selected":""}>${$e(g.name)} · ${g.component}</option>`).join(""),he("#plot-axis").hidden=!D.spectrum,Gv(he("#field-canvas"),s,t,a?a.label:n.field+" "+n.complex_display,n.complex_display==="phase"?Math.PI:i==null?void 0:i.max,a?"|E|², reduced":n.complex_display==="phase"?"rad":"reduced field"),ts(he("#monitor-canvas"),o.filter(g=>g.id===D.plotMonitor),D.spectrum,he("#plot-axis").value==="wavelength")}async function b0(){var n,e,t;if(D.mode==="layout"){if(!await Qe()){Pt("Fix the highlighted project settings before running.");return}if((n=lt.execution)!=null&&n.error){Pt(lt.execution.error),at(lt.execution.error,"error");return}try{D.results=null,D.monitors=null,D.liveFrame=null;const i=await bt("/jobs",D.project);D.job=i.id,localStorage.setItem("torchfdtd.activeJob",i.id),xn("running"),$n("fields"),at("Submitted "+D.project.name+" · "+D.project.region.backend+" · "+D.project.region.precision+((e=lt.execution)!=null&&e.mode?" · "+Ha[lt.execution.mode]:"")),lt.warnings.forEach(s=>at(s,"warning")),(((t=lt.execution)==null?void 0:t.warnings)||[]).forEach(s=>at(s,"warning")),Na()}catch(i){at(i.message,"error"),Pt(i.message)}}}async function Na(){var n,e,t;try{const i=await bt("/jobs/"+D.job),s=i.progress,a=Math.round(100*s.step/s.total);if(he("#progress-bar").style.width=a+"%",he("#progress-label").textContent=a+"%",he("#status-text").textContent=i.status==="queued"?"Queued on solver":i.status==="running"?s.blocks?`Streaming block ${s.block} / ${s.blocks} · tile ${s.tile} / ${s.tiles}`:s.tiles?`Tile ${s.tile} / ${s.tiles} · step ${s.step%(s.total/s.tiles)||s.total/s.tiles}`:"Calculating fields…":i.status,D.liveFrame=s.frame,D.tab==="fields"&&An(),["completed","cancelled","failed"].includes(i.status)){if(i.status==="failed"){localStorage.removeItem("torchfdtd.activeJob"),xn("analysis"),at(i.error,"error"),Pt(i.error);return}he("#status-text").textContent="Calculation complete · loading field results…";const r=await bt("/jobs/"+D.job+"/fields");let o=1e-20;r.frames.forEach(l=>l.forEach(c=>c.forEach(d=>o=Math.max(o,Math.abs(d))))),r.max=o,r.plan_hash=i.plan_hash,r.revision=i.revision,D.results=r,D.frame=Math.max(0,r.frames.length-1),D.monitors=i.monitors,localStorage.removeItem("torchfdtd.activeJob"),xn("analysis"),he("#status-text").textContent=i.status,he("#results-tree").innerHTML=`<button data-tab="fields">${Ne("chart-no-axes-combined")} ${((n=i.execution)==null?void 0:n.mode)==="tiled"?"Stitched plane |E|²":$e(D.project.region.field)+" field snapshots"}</button>${i.monitors.map(l=>`<button data-tab="fields">${Ne("activity")} ${$e(l.name)} · ${l.component}</button>`).join("")}${(e=i.flux_monitors)!=null&&e.length?`<button data-action="propagation">${Ne("chart-no-axes-combined")} Angular spectrum</button>`:""}<div class="run-summary"><b>${i.summary.seconds.toFixed(2)} s</b> solver loop<br>${i.summary.backend.toUpperCase()}${i.summary.cuda_graph?" · CUDA graph":""}${i.summary.cuda_kernel==="fused"?" · fused Yee / CPML":""}${i.summary.cuda_monitor_kernel==="fused"?" · shared plane DFT":""}<br>${i.summary.mcells_per_second.toFixed(1)} Mcells/s<br>${i.summary.gpu?$e(i.summary.gpu):"CPU"}<br>${i.summary.auto_shutoff?"Decay threshold reached":i.summary.cancelled?"Cancelled":"Step limit reached"}<br>${i.summary.steps} / ${i.summary.requested_steps??i.summary.steps} steps${_0(i.execution)}</div>`,ns(),Ro(),An(),at(`${i.status}: ${i.summary.steps} steps in ${i.summary.seconds.toFixed(3)} s, ${i.summary.mcells_per_second.toFixed(1)} Mcells/s. Setup ${i.summary.setup_seconds.toFixed(2)} s.`+((t=i.execution)!=null&&t.mode?` Execution: ${Ha[i.execution.mode]}${i.execution.policy?` (slab ${i.execution.policy.slab_width} × depth ${i.execution.policy.temporal_depth}, ${i.execution.policy.state_storage} banks)`:""}.`:"")),i.summary.warnings.forEach(l=>at(l,"warning"));return}Mc=setTimeout(Na,400)}catch(i){at("Connection lost: "+i.message+". Retrying the same job…","warning"),Mc=setTimeout(Na,2e3)}}function Tc(n){he("#dialog-content").innerHTML=n+'<div class="dialog-actions"><button data-close>Close</button></div>',he("#dialog").showModal(),ns()}function Ac(){w0.open()}const Pd=Vv({esc:$e,toast:Pt,log:at}),S0=jv({esc:$e,toast:Pt,log:at,getProject:()=>D.project,loadProject:async n=>{if(D.mode==="running")throw Error("Wait for the active simulation to finish before opening a scene.");const e=await bt("/validate",n);dt(),D.project=e.project,D.selected="fdtd",D.results=null,D.monitors=null,D.liveFrame=null,D.job=null,he("#results-tree").innerHTML='<div class="muted empty-hint">Run to calculate the imported scene.</div>',rt(),xn("layout"),$n("geometry"),qt(),tt.fit(),await Qe(),at("Opened independently converted FSP scene. Conversion differences are retained with the project.")}}),M0=qv({esc:$e,toast:Pt,log:at,api:bt,getProject:()=>D.project,download:Po}),E0=Wv({esc:$e,toast:Pt,log:at,getProject:()=>D.project,loadProject:async n=>{if(D.mode!=="layout")throw Error("Switch to Layout before importing geometry.");const e=await bt("/validate",n);dt(),D.project=e.project,D.selected="fdtd",D.results=null,D.monitors=null,D.liveFrame=null,D.job=null,he("#results-tree").innerHTML='<div class="muted empty-hint">Run to calculate the imported scene.</div>',rt(),xn("layout"),$n("geometry"),qt(),tt.fit(),await Qe()}}),w0=Qv({state:D,api:bt,esc:$e,toast:Pt,commit:n=>{if(D.mode!=="layout")throw Error("Switch to Layout before editing.");dt(),D.project=n,rt(),Ut(),qt(),tt.render(),Qe()}}),ms=Uv({state:D,api:bt,esc:$e,commit:n=>{if(D.mode!=="layout")throw Error("Switch to Layout before editing.");dt(),D.project=n,rt(),Ut(),tt.render(),Qe()}}),Ir=Jv({state:D,api:bt,esc:$e,toast:Pt,commit:n=>{if(D.mode!=="layout")throw Error("Switch to Layout before editing.");dt(),D.project=n,rt(),Ut(),qt(),tt.render(),Qe()}}),T0=$v({state:D,api:bt,esc:$e,commit:n=>{if(D.mode!=="layout")throw Error("Switch to Layout before editing.");dt(),D.project=n,rt(),Ut(),qt(),tt.render(),Qe()}}),A0=e0({api:bt,esc:$e}),C0=t0({esc:$e}),Cc=o0({state:D,api:bt,esc:$e,toast:Pt,numeric:Xe,dropdown:Lt,commit:n=>{if(D.mode!=="layout")throw Error("Switch to Layout before editing.");dt(),D.project=n,rt(),Ut(),qt(),tt.render(),Qe()}}),R0=l0({state:D,api:bt,esc:$e,commit:n=>{if(D.mode!=="layout")throw Error("Switch to Layout before editing.");dt(),D.project=n,rt(),Ut(),qt(),tt.render(),Qe()}}),Ts={"boundary-editor":()=>R0.open(),gds:()=>{D.mode==="layout"&&E0.open()},"geometry-vertices":()=>T0.open(D.selected),capabilities:()=>A0.open(),"inverse-design":()=>C0.open(),"global-monitor":()=>Cc.globals(),"flux-results":()=>Cc.flux(),propagation:()=>Ed({state:D,api:bt,esc:$e,toast:Pt}),"mesh-preview":()=>ms.open(),"mesh-freeze":()=>ms.freeze(),"mesh-nodes":()=>ms.editNodes(),"mesh-add":()=>ms.add(),"mesh-remove":n=>ms.remove(Number(n.dataset.index)),"global-source":()=>Ir.globals(),"source-signal":()=>Ir.signal(D.selected),"source-preview":()=>Ir.preview(D.selected),fsp:()=>Pd.open(),"fsp-native":()=>{D.mode==="layout"&&S0.open()},new:()=>{D.mode!=="running"&&Tc('<h2>Project files</h2><p>Save your current project before opening another design.</p><div class="dialog-buttons"><button data-action="save">Save current project</button><button data-action="open">Open project (.json)</button><button data-action="blank">New empty project</button></div>')},blank:async()=>{if(D.mode==="running")return;dt();const n=await bt("/examples/waveguide");n.name="Untitled",n.structures=[],n.sources=[],n.monitors=[],D.project=n,D.selected="fdtd",D.results=null,D.monitors=null,D.liveFrame=null,rt(),xn("layout"),$n("geometry"),qt(),Qe(),he("#dialog").close()},save:async()=>{D.mode==="layout"&&await Qe(),Po(JSON.stringify(D.project,null,2),D.project.name.replace(/[^a-z0-9]/gi,"_")+".json"),D.dirty=!1,at(`Project saved as JSON (revision ${D.project.revision||0}${D.project.content_sha256?", content hash "+D.project.content_sha256.slice(0,12):", content hash unavailable"}). Load the same file from Python with Project.load().`)},"export-gds":()=>M0.open(),open:()=>{D.mode!=="running"&&he("#file-input").click()},region:()=>kn("fdtd"),fit:()=>tt.fit(),materials:Ac,undo:()=>{D.mode!=="layout"||!D.history.length||(D.future.push(JSON.stringify(D.project)),D.project=JSON.parse(D.history.pop()),rt(),kn("fdtd"),Qe())},redo:()=>{D.mode!=="layout"||!D.future.length||(D.history.push(JSON.stringify(D.project)),D.project=JSON.parse(D.future.pop()),rt(),kn("fdtd"),Qe())},delete:()=>{if(D.mode!=="layout"||!Jn().length)return;dt();const n=new Set(Jn());for(const e of["structures","sources","monitors"])D.project[e]=D.project[e].filter(t=>!n.has(t.id));rt(),kn("fdtd"),Qe(),at(`Deleted ${n.size} object${n.size===1?"":"s"}.`)},duplicate:()=>{if(D.mode!=="layout"||!Jn().length)return;dt();const n=Rc(Jn().map(e=>structuredClone([...D.project.structures,...D.project.sources,...D.project.monitors].find(t=>t.id===e))));rt(),wc(n.map(e=>e.id)),Qe()},copy:()=>{if(!Jn().length)return;const n=Jn().map(e=>structuredClone([...D.project.structures,...D.project.sources,...D.project.monitors].find(t=>t.id===e)));D.clipboard=JSON.stringify(n),at(`Copied ${n.length} object${n.length===1?"":"s"}.`),Pt(`Copied ${n.length} object${n.length===1?"":"s"}. Paste with Ctrl+V.`)},paste:()=>{if(D.mode!=="layout"||!D.clipboard)return;dt();const n=Rc(JSON.parse(D.clipboard));rt(),wc(n.map(e=>e.id)),Qe(),at(`Pasted ${n.length} object${n.length===1?"":"s"}.`)},"structure-earlier":()=>Pc(-1),"structure-later":()=>Pc(1),layout:()=>{D.mode!=="running"&&(D.liveFrame=null,xn("layout"),$n("geometry"),at("Layout mode. The results of the last run stay visible and are marked stale as soon as the project plan differs from that run."))},run:b0,stop:async()=>{D.job&&(await bt("/jobs/"+D.job+"/cancel",{}),at("Stop requested. Waiting for the current time step to finish."))},validate:Qe,python:()=>Rd("python"),"export-python":async()=>{Po(await bt("/python",D.project),"simulation.py","text/x-python")},"mode-ports":()=>h0(D.project,{toast:Pt}),download:()=>{if(!D.results){Pt("Run the simulation first.");return}he("#stale-banner").hidden||at("Downloading the results of run revision "+(D.results.revision??"?")+"; the project has changed since that run.","warning"),window.location.href="/api/jobs/"+D.job+"/download"},csv:()=>{D.results?window.location.href="/api/jobs/"+D.job+(D.spectrum?"/spectra.csv":"/monitors.csv"):Pt("Run the simulation first.")},playback:()=>{var n;if(Bi){clearInterval(Bi),Bi=null;return}(n=D.results)!=null&&n.frames.length&&(Bi=setInterval(()=>{if(!D.results){clearInterval(Bi),Bi=null;return}D.frame=(D.frame+1)%D.results.frames.length,An()},80))},"add-material":()=>{dt(),D.project.materials.push({name:"Custom dielectric "+D.project.materials.length,index:1.5,color:"#60bdaa"}),rt(),he("#dialog").close(),Ac()},help:()=>Tc("<h2>From Lumerical to TorchFDTD</h2><p>The workbench follows the familiar Objects Tree, CAD views, FDTD region and Layout / Analysis workflow.</p><ol><li>Add a Rectangle, Circle, Ring or Sphere from the Design ribbon.</li><li>Select an object in the tree or any viewport. Drag to move. Edit x, y, z, spans, material and mesh order in Object properties.</li><li>Select FDTD to set dimension, mesh, PML and simulation time steps.</li><li>Add a dipole or bidirectional sheet source and point time monitors.</li><li>Run on the connected solver. Inspect field snapshots, time traces and field spectra.</li><li>Switch to Layout to edit, or export JSON, Python and NPZ results.</li></ol><p><b>Shortcuts:</b> Ctrl+S save · Ctrl+O open · Ctrl+D duplicate · Delete remove · Ctrl+Z undo · Ctrl+Y redo · F fit.</p><p>This is an independent open-source workbench. The FSP inspector reads and edits .fsp settings through an installed, licensed Lumerical API. FSP → GPU independently imports a verified subset of layout settings and displays unsupported settings and numerical differences. Arbitrary FSP execution and .lsf execution remain unimplemented. See Feature checklist for the supported physics and execution modes. PMC cavities currently use point electric sources and point monitors. General material, port and boundary combinations remain under development.</p>")};function Rc(n){const e={rectangle:"structures",circle:"structures",ring:"structures",sphere:"structures",polygon:"structures",point:"sources",plane:"sources",tfsf:"sources",field:"monitors"};return n.map(t=>(t.id=crypto.randomUUID(),t.name+="_copy",t.center[0]+=.2,D.project[e[t.kind]||"monitors"].push(t),t))}function Pc(n){if(D.mode!=="layout")return;const e=D.project.structures,t=e.findIndex(s=>s.id===D.selected),i=t+n;t<0||i<0||i>=e.length||(dt(),[e[t],e[i]]=[e[i],e[t]],rt(),kn(D.selected),Qe())}document.addEventListener("click",async n=>{var t;const e=n.target.closest("button");if(!(!e||e.disabled||!D.project||!tt))try{if(e.dataset.action&&await((t=Ts[e.dataset.action])==null?void 0:t.call(Ts,e)),e.dataset.add&&y0(e.dataset.add),e.dataset.select&&kn(e.dataset.select,n.ctrlKey||n.metaKey),e.dataset.tab&&$n(e.dataset.tab),e.dataset.bottom&&Rd(e.dataset.bottom),e.dataset.plot&&(D.spectrum=e.dataset.plot==="spectrum",ii("[data-plot]").forEach(i=>i.classList.toggle("active",i===e)),An()),e.dataset.example){if(D.mode==="running")return;dt(),D.project=await bt("/examples/"+e.dataset.example),D.results=null,D.monitors=null,D.liveFrame=null,D.selected="fdtd",rt(),xn("layout"),$n("geometry"),qt(),tt.fit(),Qe(),at("Opened example: "+D.project.name)}e.dataset.ribbon&&(ii("[data-ribbon]").forEach(i=>i.classList.toggle("active",i===e)),e.dataset.ribbon==="simulation"&&kn("fdtd"),e.dataset.ribbon==="view"&&tt.fit()),e.hasAttribute("data-close")&&he("#dialog").close()}catch(i){Pt(i.message),at(i.message,"error")}});he("#file-input").onchange=async n=>{const e=n.target.files[0];if(e){if(e.name.toLowerCase().endsWith(".fsp")){n.target.value="",he("#dialog").close(),await Pd.openFile(e);return}try{const t=JSON.parse(await e.text()),i=await bt("/validate",t);dt(),D.project=i.project,D.selected="fdtd",D.results=null,D.monitors=null,D.liveFrame=null,rt(),xn("layout"),$n("geometry"),qt(),tt.fit(),Qe(),he("#dialog").close(),at("Opened "+e.name)}catch(t){Pt(t.message)}n.target.value=""}};he("#snap").onchange=n=>D.snap=n.target.checked;he("#frame-slider").oninput=n=>{D.frame=Number(n.target.value),An()};document.addEventListener("keydown",n=>{if(!D.project||!tt||document.querySelector("dialog[open]")||["INPUT","TEXTAREA","SELECT"].includes(document.activeElement.tagName))return;const e=n.key.toLowerCase();n.ctrlKey&&["s","o","d","z","y","c","v"].includes(e)?(n.preventDefault(),Ts[{s:"save",o:"open",d:"duplicate",z:"undo",y:"redo",c:"copy",v:"paste"}[e]]()):n.key==="Delete"?Ts.delete():e==="f"&&tt.fit()});he("#plot-monitor").onchange=n=>{D.plotMonitor=n.target.value,An()};he("#plot-axis").onchange=()=>An();window.addEventListener("resize",()=>{D.tab==="fields"&&An()});async function P0(){try{vt=await bt("/health"),he(".version").textContent="DEVELOPMENT"+(vt.version?" · "+vt.version:""),he("#connection").innerHTML=`<span class="dot"></span>${vt.cuda?$e(vt.gpu):"CPU solver"} <small>${$e(vt.hostname)}</small>`,he("#footer-device").textContent=vt.cuda?"CUDA · "+vt.gpu_memory_gb+" GB":"CPU";const n=localStorage.getItem("torchfdtd.project.v1");let e=null;try{n?(e=await bt("/validate",JSON.parse(n)),D.project=e.project):D.project=await bt("/examples/waveguide")}catch{D.project=await bt("/examples/waveguide")}D.maxRevision=D.project.revision||0,tt=new Hv(he("#viewports"),D,kn,m0,dt),qt(),xn("layout"),tt.fit(),await Qe(),at("Connected to "+vt.hostname+" · "+vt.engine+"."),e&&(at(`Recovered the autosaved project "${D.project.name}" at revision ${D.project.revision||0} from browser storage.`),e.stored_content_sha256_matches===!1&&at("The autosaved project content does not match its stored content hash; it was changed outside the workbench.","warning")),at("Select an object to edit. Add structures, configure FDTD and Run. Python and JSON use the same project model.");const t=localStorage.getItem("torchfdtd.activeJob");if(t)try{const i=await bt("/jobs/"+t);D.project=i.project,D.job=t,xn("running"),qt(),$n("fields"),Na()}catch{localStorage.removeItem("torchfdtd.activeJob")}}catch(n){he("#connection").textContent="Solver unavailable",at(n.message,"error"),Pt("Cannot connect to the solver. Start torchfdtd serve and reload.")}ns()}ii(".editable").forEach(n=>n.disabled=!0);he("#run-button").disabled=!0;P0();
