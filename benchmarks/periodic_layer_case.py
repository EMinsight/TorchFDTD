...
def main():
    ...
    ap.add_argument('--steps',type=int,default=1600);args=ap.parse_args()
    ...
    project=Project(region=Region(dimension='3d',size=(*period,2*half),mesh=args.mesh,steps=args.steps,pml_cells=12,
    ...
    record=dict(grid=project.region.shape,mesh_um=args.mesh,steps=args.steps,elapsed_seconds=time.perf_counter()-start,
