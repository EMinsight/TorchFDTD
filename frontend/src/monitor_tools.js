...
export function setupMonitorTools({state,api,esc,toast,commit,numeric,dropdown}){
 ...
 return {
  ...
  async flux(){
   ...
   $('[data-plot-flux]').onclick=plot;dialog.showModal();await plot();
  }
 };
}
