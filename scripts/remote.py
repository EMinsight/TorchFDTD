...
def main():
    ...
    ap.add_argument('--python', default='python', help='CUDA-enabled base interpreter on the workstation')
    ap.add_argument('--root', default='C:/torchfdtd', help='Deployment directory on the workstation')
